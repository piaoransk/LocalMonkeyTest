...
(function (S, L) {
    ...
    var L = function () {
        var a = "undefined" === typeof S ? window : S, A = a.document, H = a.navigator && a.navigator.userAgent || "",
            F = A && A.createElementNS && !!A.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            q = /(edge|msie|trident)/i.test(H) && !a.opera, h = /Firefox/.test(H),
            l = h && 4 > parseInt(H.split("Firefox/")[1], 10);
        return a.Highcharts ? a.Highcharts.error(16,
            ...
            isMS: q,
            isWebKit: /AppleWebKit/.test(H),
            isFirefox: h,
            isChrome: -1 !== H.indexOf("Chrome"),
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0], h = this.paths[1], l = [], t = this.now, n = a.length, v;
                if (1 === t) l = this.toD; else if (n === h.length && 1 > t) for (; n--;) v = parseFloat(a[n]), l[n] = isNaN(v) ? h[n] : t * parseFloat(h[n] - v) + v; else l = h;
                this.elem.attr("d", l, null, !0)
            }, update: function () {
                var a =
                    this.elem, h = this.prop, l = this.now, t = this.options.step;
                if (this[h + "Setter"]) this[h + "Setter"](); else a.attr ? a.element && a.attr(h, l, null, !0) : a.style[h] = l + this.unit;
                t && t.call(a, l, this)
            }, run: function (q, h, l) {
                ...
                n.attr && !n.element ? q = !1 : q || h >= u + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), l = b[this.prop] = !0, a.objectEach(b, function (a) {
                    !0 !== a && (l = !1)
                }), l && v && v.call(n), q = !1) : (this.pos = t.easing((h - this.startTime) /
                ...
                function v(a, b) {
                    for (var f = (c - a.length) / e; 0 < f && f--;) m = a.slice().splice(a.length /
                ...
                g && (t(h), t(l));
                if (b && d) {
                    for (f = 0; f < b.length; f++) if (b[f] === d[0]) {
                        u = f;
                        break
        ...
        a.merge = function () {
            var q, h = arguments, l, t = {}, n = function (l, q) {
                "object" !== typeof l && (l = {});
                a.objectEach(q, function (b, d) {
                    !a.isObject(b, !0) || a.isClass(b) || a.isDOMElement(b) ? l[d] = q[d] : l[d] = n(l[d] || {}, b)
                });
                return l
            };
            !0 === h[0] && (t = h[1], h = Array.prototype.slice.call(h, 2));
            l = h.length;
            for (q = 0; q < l; q++) t = n(t, h[q]);
            return t
        };
        a.pInt = function (a, h) {
        ...
        a.isObject = function (q, h) {
            return !!q && "object" === typeof q && (!h || !a.isArray(q))
        };
        a.isDOMElement = function (q) {
            return a.isObject(q) && "number" === typeof q.nodeType
        };
        a.isClass = function (q) {
            var h = q && q.constructor;
            return !(!a.isObject(q, !0) || a.isDOMElement(q) || !h || !h.name || "Object" === h.name)
        };
        ...
        a.attr = function (q, h, l) {
            var t;
            a.isString(h) ? a.defined(l) ? q.setAttribute(h, l) : q && q.getAttribute && (t = q.getAttribute(h)) : a.defined(h) && a.isObject(h) && a.objectEach(h, function (a, l) {
                q.setAttribute(l, a)
            });
            return t
        };
        ...
        a.syncTimeout = function (a, h, l) {
            if (h) return setTimeout(a, h, l);
            a.call(0, l)
        };
        ...
        a.pick = function () {
            var a = arguments, h, l, t = a.length;
            for (h = 0; h < t; h++) if (l = a[h], void 0 !== l && null !== l) return l
        };
        a.css = function (q, h) {
            a.isMS && !a.svg && h && void 0 !== h.opacity && (h.filter = "alpha(opacity\x3d" + 100 * h.opacity + ")");
            a.extend(q.style, h)
        };
        a.createElement = function (q, h, l, t, n) {
            q = H.createElement(q);
            var v = a.css;
            h && a.extend(q, h);
        ...
        a.pad = function (a, h, l) {
            return Array((h || 2) + 1 - String(a).length).join(l || 0) + a
        };
        a.relativeLength = function (a, h, l) {
            return /%$/.test(a) ? h * parseFloat(a) / 100 + (l || 0) : parseFloat(a)
        };
        a.wrap = function (a, h, l) {
            var t = a[h];
            a[h] = function () {
        ...
        a.format = function (q, h, l) {
            for (var t = "{", n = !1, v, u, b, d, g = [], e; q;) {
                t = q.indexOf(t);
                if (-1 === t) break;
                v = q.slice(0, t);
                if (n) {
        ...
        a.normalizeTickInterval = function (q, h, l, t, n) {
            var v, u = q;
            l = a.pick(l, 1);
            v = q / l;
            h || (h = n ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === t && (1 === l ? h = a.grep(h, function (a) {
                return 0 === a % 1
            }) : .1 >= l && (h = [1 / l])));
            for (t = 0; t < h.length && !(u = h[t], n && u * l >= q || !n && v <= (h[t] + (h[t + 1] || h[t])) / 2); t++) ;
        ...
        a.arrayMin = function (a) {
            for (var h = a.length, l = a[0]; h--;) a[h] < l && (l = a[h]);
            return l
        };
        ...
        a.destroyObjectProperties = function (q, h) {
        ...
        a.setAnimation = function (q, h) {
            h.renderer.globalAnimation = a.pick(q, h.options.chart.animation, !0)
        };
        ...
        a.numberFormat = function (q, h, l, t) {
            q = +q || 0;
            h = +h;
            var n = a.defaultOptions.lang, v = (q.toString().split(".")[1] || "").split("e")[0].length, u, b,
                d = q.toString().split("e");
        ...
        a.getStyle = function (q, h, l) {
            if ("width" === h) return Math.min(q.offsetWidth, q.scrollWidth) - a.getStyle(q, "padding-left") - a.getStyle(q, "padding-right");
            if ("height" === h) return Math.min(q.offsetHeight, q.scrollHeight) - a.getStyle(q, "padding-top") - a.getStyle(q, "padding-bottom");
            F.getComputedStyle || a.error(27, !0);
            if (q = F.getComputedStyle(q, void 0)) q = q.getPropertyValue(h), a.pick(l, "opacity" !== h) && (q = a.pInt(q));
            return q
        };
        a.inArray = function (q, h) {
            return (a.indexOfPolyfill || Array.prototype.indexOf).call(h,
                q)
        };
        a.grep = function (q, h) {
            return (a.filterPolyfill || Array.prototype.filter).call(q, h)
        };
        a.find = Array.prototype.find ? function (a, h) {
            return a.find(h)
        } : function (a, h) {
            var l, t = a.length;
            for (l = 0; l < t; l++) if (h(a[l], l)) return a[l]
        };
        a.map = function (a, h) {
            for (var l = [], t = 0, n = a.length; t < n; t++) l[t] = h.call(a[t], a[t], t, a);
            return l
        };
        a.keys = function (q) {
            return (a.keysPolyfill || Object.keys).call(void 0, q)
        };
        a.reduce = function (q, h, l) {
            return (a.reducePolyfill || Array.prototype.reduce).call(q, h, l)
        };
        a.offset = function (a) {
        ...
        a.stop = function (q, h) {
            for (var l = a.timers.length; l--;) a.timers[l].elem !== q || h && h !== a.timers[l].prop || (a.timers[l].stopped = !0)
        };
        a.each = function (q, h, l) {
            return (a.forEachPolyfill || Array.prototype.forEach).call(q, h, l)
        };
        a.objectEach = function (a, h, l) {
            for (var t in a) a.hasOwnProperty(t) && h.call(l, a[t], t, a)
        };
        a.addEvent = function (q,
                               h, l) {
            var t, n, v = q.addEventListener || a.addEventListenerPolyfill;
            q.hcEvents && !Object.prototype.hasOwnProperty.call(q, "hcEvents") && (n = {}, a.objectEach(q.hcEvents, function (a, b) {
                n[b] = a.slice(0)
            }), q.hcEvents = n);
            t = q.hcEvents = q.hcEvents || {};
            v && v.call(q, h, l, !1);
            t[h] || (t[h] = []);
            t[h].push(l);
            return function () {
        ...
        a.removeEvent = function (q, h, l) {
            function t(b, g) {
                var e = q.removeEventListener || a.removeEventListenerPolyfill;
                e && e.call(q, b, g, !1)
            }
            ...
            function n() {
                ...
                q.nodeName && (h ? (b = {}, b[h] = !0) : b = u,
                    a.objectEach(b, function (a, b) {
                        if (u[b]) for (g = u[b].length; g--;) t(b, u[b][g])
                    }))
            }
        ...
        a.fireEvent = function (q, h, l, t) {
            ...
            var v, u;
            l = l || {};
            if (H.createEvent && (q.dispatchEvent || q.fireEvent)) n = H.createEvent("Events"), n.initEvent(h, !0, !0), a.extend(n, l), q.dispatchEvent ? q.dispatchEvent(n) : q.fireEvent(h, n); else if (n) for (n = n[h] || [], v = n.length, l.target || a.extend(l, {
                preventDefault: function () {
                    l.defaultPrevented =
                        !0
                }, target: q, type: h
            }), h = 0; h < v; h++) (u = n[h]) && !1 === u.call(q, l) && l.preventDefault();
        ...
        a.seriesType = function (q, h, l, t, n) {
            var v = a.getOptions(), u = a.seriesTypes;
            v.plotOptions[q] = a.merge(v.plotOptions[h], l);
            u[q] = a.extendClass(u[h] || function () {
            }, t);
        ...
        F.jQuery && (F.jQuery.fn.highcharts = function () {
            ...
            if (this[0]) return q[0] ? (new (a[a.isString(q[0]) ? q.shift() : "Chart"])(this[0], q[0], q[1]), this) : A[a.attr(this[0], "data-highcharts-chart")]
        })
    })(L);
    (function (a) {
        ...
        a.Color.prototype = {
            parsers: [{
                ...
                var h, n, v, u;
                if ((this.input = l = this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) && l.stops) this.stops = F(l.stops, function (b) {
                    return new a.Color(b[1])
                }); else if (l && l.charAt && "#" === l.charAt() && (h = l.length, l = parseInt(l.substr(1),
                        16), 7 === h ? n = [(l & 16711680) >> 16, (l & 65280) >> 8, l & 255, 1] : 4 === h && (n = [(l & 3840) >> 4 | (l & 3840) >> 8, (l & 240) >> 4 | l & 240, (l & 15) << 4 | l & 15, 1])), !n) for (v = this.parsers.length; v-- && !n;) u = this.parsers[v], (h = u.regex.exec(l)) && (n = u.parse(h));
                this.rgba = n || []
            }, get: function (a) {
                var l = this.input, n = this.rgba, h;
                this.stops ? (h = q(l), h.stops = [].concat(h.stops), A(this.stops, function (n, b) {
                    h.stops[b] = [h.stops[b][0], n.get(a)]
                })) : h = n && H(n[0]) ? "rgb" === a || !a && 1 === n[3] ? "rgb(" + n[0] + "," + n[1] + "," + n[2] + ")" : "a" === a ? n[3] : "rgba(" + n.join(",") + ")" : l;
                return h
            }, brighten: function (a) {
                var l, n = this.rgba;
                if (this.stops) A(this.stops, function (n) {
                    n.brighten(a)
                }); else if (H(a) && 0 !== a) for (l = 0; 3 > l; l++) n[l] += h(255 * a), 0 > n[l] && (n[l] = 0), 255 < n[l] && (n[l] = 255);
                return this
    ...
    (function (a) {
        var A, H, F = a.addEvent, q = a.animate, h = a.attr, l = a.charts, t = a.color, n = a.css, v = a.createElement,
            u = a.defined, b = a.deg2rad, d = a.destroyObjectProperties, g = a.doc, e = a.each, c = a.extend,
            m = a.erase, f = a.grep, r = a.hasTouch, w = a.inArray, K = a.isArray, z = a.isFirefox, I = a.isMS,
            D = a.isObject, C = a.isString, y = a.isWebKit, G = a.merge, B = a.noop, J = a.objectEach, E = a.pick,
        ...
        c(A.prototype, {
            ...
            init: function (a, k) {
                this.element = "span" === k ? v(k) : g.createElementNS(this.SVG_NS, k);
                this.renderer = a
            },
            animate: function (x, k, b) {
                k = a.animObject(E(k, this.renderer.globalAnimation, !0));
                0 !== k.duration ? (b && (k.complete = b), q(this, x, k)) : (this.attr(x, null, b), k.step && k.step.call(this));
                return this
            },
            colorGradient: function (x, k, b) {
                ...
                f && (m = x[f], r = p.gradients, R = x.stops, B = b.radialReference, K(m) && (x[f] = m = {
                    x1: m[0],
                    y1: m[1],
                    x2: m[2],
                    y2: m[3],
                    gradientUnits: "userSpaceOnUse"
                }), "radialGradient" === f && B && !u(m.gradientUnits) && (d = m, m = G(m, p.getRadialAttr(B, d), {gradientUnits: "userSpaceOnUse"})), J(m, function (a, x) {
                    "id" !== x && w.push(x, a)
                }), J(R, function (a) {
                    w.push(a)
                }), w = w.join(","), r[w] ? B = r[w].attr("id") :
                    (m.id = B = a.uniqueKey(), r[w] = N = p.createElement(f).attr(m).add(p.defs), N.radAttr = d, N.stops = [], e(R, function (x) {
                        0 === x[1].indexOf("rgba") ? (c = a.color(x[1]), y = c.get("rgb"), g = c.get("a")) : (y = x[1], g = 1);
                        x = p.createElement("stop").attr({offset: x[0], "stop-color": y, "stop-opacity": g}).add(N);
                        N.stops.push(x)
                    })), O = "url(" + p.url + "#" + B + ")", b.setAttribute(k, O), b.gradient = w, x.toString = function () {
                    return O
                })
            },
            applyTextOutline: function (x) {
                ...
                if ((c = x[0]) && "none" !== c && a.svg) {
                    ...
                    c = c.replace(/(^[\d\.]+)(.*?)$/g, function (a, x, k) {
                        return 2 * x + k
                    });
                    for (d = x.length; d--;) b = x[d], "highcharts-text-outline" === b.getAttribute("class") && m(x, k.removeChild(b));
                    f = k.firstChild;
                    e(x, function (a, x) {
            ...
            updateShadows: function (a, k, b) {
                for (var x = this.shadows, p = x.length; p--;) b.call(x[p], "height" === a ? Math.max(k - (x[p].cutHeight || 0), 0) : "d" === a ? this.d : k, a, x[p])
            },
            ...
            crisp: function (a, k) {
                ...
                u(a.strokeWidth) && (a.strokeWidth = k);
                return a
            },
            css: function (a) {
                var x = this.styles, b = {}, p = this.element, e, f = "", m, d = !x,
                    r = ["textOutline", "textOverflow", "width"];
                a && a.color && (a.fill = a.color);
                x && J(a, function (a, k) {
                    a !== x[k] && (b[k] = a, d = !0)
                });
                d && (x && (a = c(x, b)), e = this.textWidth = a && a.width && "auto" !== a.width && "text" === p.nodeName.toLowerCase() && k(a.width), this.styles = a, e && !O && this.renderer.forExport && delete a.width, p.namespaceURI === this.SVG_NS ? (m = function (a, x) {
                    return "-" + x.toLowerCase()
                }, J(a, function (a, x) {
                    -1 === w(x, r) && (f += x.replace(/([A-Z])/g, m) + ":" + a + ";")
                }), f && h(p, "style", f)) : n(p, a), this.added && ("text" === this.element.nodeName && this.renderer.buildText(this), a && a.textOutline && this.applyTextOutline(a.textOutline)));
                return this
            },
            ...
            on: function (a, k) {
                var x = this, b = x.element;
                r && "click" === a ? (b.ontouchstart = function (a) {
                    x.touchEventFired = Date.now();
                    a.preventDefault();
                    k.call(b, a)
                }, b.onclick = function (a) {
                    (-1 === Q.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (x.touchEventFired || 0)) && k.call(b, a)
                }) : b["on" + a] = k;
                return this
            },
            ...
            updateTransform: function () {
                var a = this.translateX || 0, k = this.translateY || 0, b = this.scaleX, p = this.scaleY,
                    c = this.inverted, e = this.rotation, f = this.matrix, m = this.element;
                c && (a += this.width, k += this.height);
                a = ["translate(" + a + "," + k + ")"];
                u(f) && a.push("matrix(" + f.join(",") + ")");
                c ? a.push("rotate(90) scale(-1,1)") : e && a.push("rotate(" + e + " " + E(this.rotationOriginX, m.getAttribute("x"), 0) + " " + E(this.rotationOriginY,
                    m.getAttribute("y") || 0) + ")");
            ...
            align: function (a, k, b) {
                ...
                var d, r;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = k, !b || C(b)) this.alignTo = x = b || "renderer", m(c, this), c.push(this), b = null
                } else a = this.alignOptions, k = this.alignByTranslate, x = this.alignTo;
                b = E(b, p[x], p);
                x = a.align;
                p = a.verticalAlign;
                c = (b.x || 0) + (a.x || 0);
            ...
            getBBox: function (a, k) {
                var x, p = this.renderer, f, m = this.element, d = this.styles, r, N = this.textStr, y, g = p.cache,
                    B = p.cacheKeys, G;
                k = E(k, this.rotation);
                f = k * b;
                r = d && d.fontSize;
                ...
                if (!x) {
                    if (m.namespaceURI === this.SVG_NS || p.forExport) {
                        try {
                            (y = this.fakeTS && function (a) {
                                e(m.querySelectorAll(".highcharts-text-outline"), function (x) {
                                    x.style.display = a
                                })
                            }) && y("none"), x = m.getBBox ? c({}, m.getBBox()) : {
                                width: m.offsetWidth,
                    ...
                    if (G && 0 < x.height) {
                        for (; 250 < B.length;) delete g[B.shift()];
                        g[G] || B.push(G);
                        g[G] = x
                    }
                }
            ...
            destroy: function () {
                var a = this, k = a.element || {}, b = a.renderer.isSVG && "SPAN" === k.nodeName && a.parentGroup,
                    p = k.ownerSVGElement, c = a.clipPath;
                k.onclick =
                    k.onmouseout = k.onmouseover = k.onmousemove = k.point = null;
                M(a);
                c && p && (e(p.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
                    var k = a.getAttribute("clip-path"), x = c.element.id;
                    (-1 < k.indexOf("(#" + x + ")") || -1 < k.indexOf('("#' + x + '")')) && a.removeAttribute("clip-path")
                ...
                a.safeRemoveChild(k);
                for (a.destroyShadows(); b && b.div && 0 === b.div.childNodes.length;) k = b.parentGroup, a.safeRemoveChild(b.div), delete b.div,
                    b = k;
            ...
            shadow: function (a, k, b) {
                ...
                if (!a) this.destroyShadows(); else if (!this.shadows) {
                    ...
                    for (p = 1; p <= m; p++) c = f.cloneNode(0), e = 2 * m + 1 - 2 * p, h(c, {
                        isShadow: "true",
                        ...
                        fill: "none"
                    }), b && (h(c, "height", Math.max(h(c,
                        "height") - e, 0)), c.cutHeight = e), k ? k.element.appendChild(c) : f.parentNode && f.parentNode.insertBefore(c, f), x.push(c);
                    this.shadows = x
                }
                return this
            },
            ...
            titleSetter: function (a) {
                ...
                k.appendChild(g.createTextNode(String(E(a),
            ...
            zIndexSetter: function (a, b) {
                var p = this.renderer, x = this.parentGroup, c = (x || p).element || p.box, f, e = this.element,
                    m, d, p = c === p.box;
                f = this.added;
                var r;
                ...
                if (f) {
                    ...
                    b = c.childNodes;
                    for (r = b.length - 1; 0 <= r && !m; r--) if (x = b[r], f = x.zIndex, d = !u(f), x !== e) if (0 > a && d && !p && !r) c.insertBefore(e, b[r]), m = !0; else if (k(f) <= a || d && (!u(a) || 0 <= a)) c.insertBefore(e, b[r + 1] || null), m = !0;
        ...
        A.prototype.translateXSetter =
            A.prototype.translateYSetter = A.prototype.rotationSetter = A.prototype.verticalAlignSetter = A.prototype.rotationOriginXSetter = A.prototype.rotationOriginYSetter = A.prototype.scaleXSetter = A.prototype.scaleYSetter = A.prototype.matrixSetter = function (a, k) {
                this[k] = a;
                this.doTransform = !0
            };
        ...
        c(H.prototype, {
            ...
            applyEllipsis: function (a, k, b, p) {
                var c = a.rotation, x = b, f, e = 0, m = b.length, d = function (a) {
                ...
                if (r = x > p) {
                    for (; e <= m;) f = Math.ceil((e + m) / 2), x = b.substring(0, f) + "\u2026", d(x), x = this.getSpanWidth(a, k), e === m ? e = m + 1 : x > p ? m = f - 1 : e = f;
                    0 === m && d("")
                }
                a.rotation = c;
                return r
            ...
            buildText: function (a) {
                var b = a.element, p = this, c = p.forExport, x = E(a.textStr, "").toString(),
                    m = -1 !== x.indexOf("\x3c"), d = b.childNodes, r, y, B, G, z = h(b, "x"), M = a.styles,
                    P = a.textWidth, l = M && M.lineHeight, D = M && M.textOutline,
                    u = M && "ellipsis" === M.textOverflow, C = M && "nowrap" === M.whiteSpace, v = M && M.fontSize, I,
                    t, K = d.length, M = P && !a.added && this.box, Q = function (a) {
                        var c;
                        c = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : v || p.style.fontSize || 12;
                        return l ? k(l) : p.fontMetrics(c, a.getAttribute("style") ? a : b).h
                    }, q = function (a, k) {
                        J(p.escapes, function (b, p) {
                            k && -1 !== w(b, k) || (a = a.toString().replace(new RegExp(b, "g"), p))
                        });
                        return a
                    };
                ...
                if (I !== a.textCache) {
                    ...
                    m || D || u || P || -1 !== x.indexOf(" ") ?
                        (r = /<.*class="([^"]+)".*>/, y = /<.*style="([^"]+)".*>/, B = /<.*href="([^"]+)".*>/, M && M.appendChild(b), x = m ? x.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [x], x = f(x, function (a) {
                            return "" !== a
                        }), e(x, function (k, x) {
                            var f, m = 0;
                                ...
                                if ("" !== k || 1 === f.length) {
                                    ...
                                    if (" " !== k) {
                                        ...
                                        if (P) {
                                            ...
                                            for (u && (G = p.applyEllipsis(a, d, k, P)); !u && w && (e.length || l.length);) a.rotation = 0, D = p.getSpanWidth(a, d), k = D > P, void 0 === G && (G = k), k && 1 !== e.length ? (d.removeChild(d.firstChild), l.unshift(e.pop())) : (e = l, l = [], e.length && !C && (d = g.createElementNS(N, "tspan"), h(d, {
                                                dy: J,
                                                x: z
                                            }), M && h(d, "style", M), b.appendChild(d)), D > P && (P = D)), e.length && d.appendChild(g.createTextNode(e.join(" ").replace(/- /g,
                                                "-")));
                                            a.rotation = E
                                        }
                                        m++
            ...
            button: function (a, k, b, p, e, f, d, m, r) {
                ...
                w = m.style;
                delete m.style;
                F(x.element, I ? "mouseover" : "mouseenter", function () {
                    3 !== y && x.setState(1)
                });
                F(x.element, I ? "mouseout" : "mouseleave", function () {
                    3 !== y && x.setState(y)
                });
            ...
            circle: function (a, k, b) {
                ...
                k.xSetter =
                    k.ySetter = function (a, k, b) {
                        b.setAttribute("c" + k, a)
                    };
                return k.attr(a)
            },
            arc: function (a, k, b, p, c, e) {
                D(a) ? (p = a, k = p.y, b = p.r, a = p.x) : p = {innerR: p, start: c, end: e};
                a = this.symbol("arc", a, k, b, b, p);
                a.r = b;
                return a
            },
            rect: function (a, k, b, p, c, e) {
                c = D(a) ? a.r : c;
                var f = this.createElement("rect");
                a = D(a) ? a : void 0 === a ? {} : {x: a, y: k, width: Math.max(b, 0), height: Math.max(p, 0)};
                void 0 !== e && (a.strokeWidth = e, a = f.crisp(a));
                a.fill = "none";
                c && (a.r = c);
                f.rSetter = function (a, k, b) {
                    h(b, {rx: a, ry: a})
                };
                return f.attr(a)
            },
            setSize: function (a, k, b) {
                var p =
                    this.alignedObjects, c = p.length;
                this.width = a;
                this.height = k;
            ...
            symbol: function (a, k, b, p, f, d) {
                var m = this, x, r = /^url\((.*?)\)$/, y = r.test(a), N = !y && (this.symbols[a] ? a : "circle"),
                    B = N && this.symbols[N],
                    G = u(k) && B && B.call(this.symbols, Math.round(k), Math.round(b), p, f, d), w, O;
                B ? (x = this.path(G), x.attr("fill", "none"), c(x, {
                    symbolName: N,
                    x: k,
                    y: b,
                    width: p,
                    height: f
                }), d && c(x, d)) : y && (w = a.match(r)[1], x = this.image(w), x.imgwidth = E(P[w] && P[w].width, d && d.width), x.imgheight =
                    E(P[w] && P[w].height, d && d.height), O = function () {
                    x.attr({width: x.width, height: x.height})
                }, e(["width", "height"], function (a) {
                    x[a + "Setter"] = function (a, k) {
                        var b = {}, p = this["img" + k], c = "width" === k ? "translateX" : "translateY";
                        this[k] = a;
                        u(p) && (this.element && this.element.setAttribute(k, p), this.alignByTranslate || (b[c] = ((this[k] || 0) - p) / 2, this.attr(b)))
                    }
                }), u(k) && x.attr({
                    x: k,
                    y: b
                }), x.isImg = !0, u(x.imgwidth) && u(x.imgheight) ? O() : (x.attr({width: 0, height: 0}), v("img", {
                    onload: function () {
            ...
            symbols: {
                circle: function (a, k, b, p) {
                    return this.arc(a + b / 2, k + p / 2, b / 2, p / 2, {start: 0, end: 2 * Math.PI, open: !1})
                }, square: function (a, k, b, p) {
                    return ["M", a, k, "L", a + b, k, a + b, k + p, a, k + p, "Z"]
                }, triangle: function (a,
                                       k, b, p) {
                    return ["M", a + b / 2, k, "L", a + b, k + p, a, k + p, "Z"]
                }, "triangle-down": function (a, k, b, p) {
                    return ["M", a, k, "L", a + b, k, a + b / 2, k + p, "Z"]
                }, diamond: function (a, k, b, p) {
                    return ["M", a + b / 2, k, "L", a + b, k + p / 2, a + b / 2, k + p, a, k + p / 2, "Z"]
                }, arc: function (a, k, b, p, c) {
                    ...
                    d && d > b ? c > k + f && c < k + p - f ? m.splice(13, 3, "L", a + b, c - 6, a + b + 6, c, a + b, c + 6, a + b, k + p - e) : m.splice(13, 3, "L", a + b, p / 2, d, c, a + b, p / 2, a + b, k + p - e) : d && 0 > d ? c > k + f && c < k + p - f ? m.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6,
                        a, k + e) : m.splice(33, 3, "L", a, p / 2, d, c, a, p / 2, a, k + e) : c && c > p && d > a + f && d < a + b - f ? m.splice(23, 3, "L", d + 6, k + p, d, k + p + 6, d - 6, k + p, a + e, k + p) : c && 0 > c && d > a + f && d < a + b - f && m.splice(3, 3, "L", d - 6, k, d, k - 6, d + 6, k, b - e, k);
                    return m
                }
            },
            clipRect: function (k, b, p, c) {
                var e = a.uniqueKey(), f = this.createElement("clipPath").attr({id: e}).add(this.defs);
                k = this.rect(k, b, p, c, 0).add(f);
                k.id = e;
                k.clipPath = f;
                k.count = 0;
                return k
            },
            text: function (a, k, b, p) {
                var c = {};
                if (p && (this.allowHTML || !this.forExport)) return this.html(a, k, b);
                c.x = Math.round(k || 0);
                b && (c.y =
                    Math.round(b));
                if (a || 0 === a) c.text = a;
                a = this.createElement("text").attr(c);
                p || (a.xSetter = function (a, k, b) {
                    var p = b.getElementsByTagName("tspan"), c, e = b.getAttribute(k), f;
                    for (f = 0; f < p.length; f++) c = p[f], c.getAttribute(k) === e && c.setAttribute(k, a);
                    b.setAttribute(k, a)
                });
                return a
            },
            ...
            rotCorr: function (a, k, p) {
                var c = a;
                k && p && (c = Math.max(c * Math.cos(k * b), 4));
                return {x: -a / 3 * Math.sin(k * b), y: c}
            },
            label: function (k, b, f, d, m, r, y, N, B) {
                var x = this, g = x.g("button" !== B && "label"), w = g.text = x.text("", 0, 0, y).attr({zIndex: 1}), O,
                    M, z = 0, n = 3, P = 0, l, D, h, J, E, C = {}, v, I, t = /^url\((.*?)\)$/.test(d), K = t, Q, q, R,
                    T;
                ...
                R = function () {
                    var a = P + n, k;
                    k = N ? 0 : I;
                    u(l) && M && ("center" === E || "right" === E) && (a += {center: .5, right: 1}[E] * (l - M.width));
                ...
                g.onAdd = function () {
                    w.add(g);
                    g.attr({text: k || 0 === k ? k : "", x: b, y: f});
                    O && u(m) && g.attr({anchorX: m, anchorY: r})
                };
                g.widthSetter = function (k) {
                    l = a.isNumber(k) ? k : null
                };
                ...
                g["stroke-widthSetter"] = function (a, k) {
                    a && (K = !0);
                    v = this["stroke-width"] = a;
                    T(k, a)
                };
                g.strokeSetter = g.fillSetter = g.rSetter = function (a, k) {
                    "r" !== k && ("fill" === k && a && (K = !0), g[k] = a);
                    T(k, a)
                };
                g.anchorXSetter = function (a, k) {
                    m = g.anchorX = a;
                    T(k, Math.round(a) - Q() - h)
                };
                g.anchorYSetter = function (a, k) {
                    r = g.anchorY = a;
                    T(k, a - J)
                };
                ...
                return c(g, {
                    css: function (a) {
                        ...
                        p(g.element, "mouseenter");
                        p(g.element, "mouseleave");
                        w && (w = w.destroy());
                        O && (O = O.destroy());
                        A.prototype.destroy.call(g);
                        g = x = q = R = T = null
                    }
                })
            }
    ...
    (function (a) {
        var A = a.attr, H = a.createElement, F = a.css, q = a.defined, h = a.each, l = a.extend,
            t = a.isFirefox, n = a.isMS, v = a.isWebKit, u = a.pick, b = a.pInt, d = a.SVGRenderer, g = a.win,
            e = a.wrap;
        l(a.SVGElement.prototype, {
            ...
            htmlUpdateTransform: function () {
                if (this.added) {
                    var a = this.renderer, e = this.element, f = this.translateX || 0, d = this.translateY || 0,
                        g = this.x || 0, n = this.y || 0, z = this.textAlign || "left",
                        l = {left: 0, center: .5, right: 1}[z], D = this.styles, C = D && D.whiteSpace;
                    F(e, {marginLeft: f, marginTop: d});
                    this.shadows && h(this.shadows, function (a) {
                        F(a, {marginLeft: f + 1, marginTop: d + 1})
                    });
                    this.inverted && h(e.childNodes, function (b) {
                        a.invertChild(b, e)
                    });
                    if ("SPAN" === e.tagName) {
                        var D = this.rotation, y = this.textWidth && b(this.textWidth), G = [D, z, e.innerHTML,
                            this.textAlign].join(), B;
                        (B = y !== this.oldTextWidth) && !(B = y > this.oldTextWidth) && ((B = this.textPxLength) || (F(e, {
                            width: "",
                            whiteSpace: C || "nowrap"
                        }), B = e.offsetWidth), B = B > y);
                        B && /[ \-]/.test(e.textContent || e.innerText) && (F(e, {
                            width: y + "px",
                            display: "block",
                            whiteSpace: C || "normal"
                        }), this.oldTextWidth = y);
                ...
                c[f + (t ? "Origin" : "-origin")] = c.transformOrigin = 100 * b + "% " + e + "px";
                F(this.element, c)
        ...
        l(d.prototype, {
            getTransformKey: function () {
                ...
                var c = this.createElement("span"), d = c.element, m = c.renderer, g = m.isSVG, n = function (a, b) {
                    h(["opacity", "visibility"], function (c) {
                        e(a, c + "Setter", function (a, c, e, f) {
                            a.call(this, c, e, f);
                            b[e] = c
                        })
                    })
                ...
                c.attr({text: a, x: Math.round(b), y: Math.round(f)}).css({
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            h(f.reverse(), function (a) {
                                function d(k, b) {
                                    a[b] = k;
                                    "translateX" === b ? m.left = k + "px" : m.top = k + "px";
                                    a.doTransform = !0
                                }

                                var m, k = A(a.element, "class");
                                k && (k = {className: k});
                                b = a.div = a.div || H("div", k, {
                                    position: "absolute",
                                ...
                                l(a, {
                                    classSetter: function (a) {
                                        ...
                                        f[0].div && c.on.apply({element: f[0].div}, arguments);
                                        return a
    ...
    (function (a) {
        var A =
            a.defined, H = a.each, F = a.extend, q = a.merge, h = a.pick, l = a.timeUnits, t = a.win;
        a.Time = function (a) {
            this.update(a, !1)
        };
        a.Time.prototype = {
            defaultOptions: {}, update: function (n) {
                ...
                (this.variableTimezone = !(l && !n.getTimezoneOffset && !n.timezone)) || this.timezoneOffset ? (this.get = function (a, d) {
                    ...
                    d.setTime(b);
                    return a
                }, this.set = function (b, d, g) {
                    var e;
                    if (-1 !== a.inArray(b, ["Milliseconds", "Seconds", "Minutes"])) d["set" + b](g); else e = u.getTimezoneOffset(d), e = d.getTime() - e, d.setTime(e), d["setUTC" + b](g), b = u.getTimezoneOffset(d), e = d.getTime() + b, d.setTime(e)
                }) : l ? (this.get = function (a, d) {
                    return d["getUTC" + a]()
                }, this.set = function (a, d, g) {
                    return d["setUTC" + a](g)
                    ...
                    return d["set" + a](g)
                                   ...
                                   l, u, b, d, g) {
                var e, c, m;
                this.useUTC ? (e = this.Date.UTC.apply(0, arguments), c = this.getTimezoneOffset(e), e += c, m = this.getTimezoneOffset(e), c !== m ? e += m - c : c - 36E5 === this.getTimezoneOffset(e - 36E5) && (a.isChrome || a.isMS) && (e -= 36E5)) : e = (new this.Date(n, l, h(u, 1), h(b, 0), h(d, 0), h(g, 0))).getTime();
                return e
                ...
                if (l.timezone) {
                    if (h) return function (a) {
                        return 6E4 * -h.tz(a, l.timezone).utcOffset()
                    };
                    a.error(25)
                }
                ...
                var b = this, d = new this.Date(l), g = this.get("Hours", d), e = this.get("Day", d),
                    c = this.get("Date", d), m = this.get("Month", d), f = this.get("FullYear", d),
                    r = a.defaultOptions.lang, w = r.weekdays, u = r.shortWeekdays, z = a.pad, d = a.extend({
                        a: u ? u[e] : w[e].substr(0,
                            3),
                        A: w[e],
                        d: z(c),
                        e: z(c, 2, " "),
                        ...
                        P: 12 > g ? "am" : "pm",
                        S: z(d.getSeconds()),
                        L: z(Math.round(l % 1E3), 3)
                    }, a.dateFormats);
                a.objectEach(d, function (a, c) {
                    for (; -1 !== n.indexOf("%" + c);) n = n.replace("%" + c, "function" === typeof a ? a.call(b, l) : a)
                });
                return h ? n.substr(0, 1).toUpperCase() + n.substr(1) : n
            }, getTimeTicks: function (a, v, u, b) {
                var d = this, g = [], e = {}, c, m = new d.Date(v), f = a.unitRange,
                    r = a.count || 1, w;
                if (A(v)) {
                    ...
                    m = m.getTime();
                    for (v = 1; m < u;) g.push(m), m = f === l.year ? d.makeTime(c + v * r, 0) : f === l.month ? d.makeTime(c, b + v * r) : !w || f !== l.day && f !== l.week ? w && f === l.hour && 1 < r ? d.makeTime(c, b, n, z + v * r) : m + f * r : d.makeTime(c, b, n + v * r * (f === l.day ? 1 : 7)),
                        v++;
                    g.push(m);
                    f <= l.hour && 1E4 > g.length && H(g, function (a) {
    ...
    (function (a) {
        ...
        a.setOptions = function (A) {
            a.defaultOptions = H(!0, a.defaultOptions, A);
        ...
        a.dateFormat = function (A, q, h) {
            return a.time.dateFormat(A, q, h)
        }
    })(L);
    (function (a) {
        var A = a.correctFloat, H = a.defined, F = a.destroyObjectProperties, q = a.isNumber, h = a.merge, l = a.pick,
            t = a.deg2rad;
        a.Tick = function (a, l, h, b) {
            this.axis = a;
            this.pos = l;
            this.type = h || "";
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, v = a.options, u = a.chart, b = a.categories, d = a.names, g =
                        this.pos, e = v.labels, c = a.tickPositions, m = g === c[0], f = g === c[c.length - 1],
                    d = b ? l(b[g], d[g], g) : g, b = this.label, c = c.info, r;
                ...
                v = a.labelFormatter.call({
                    ...
                    value: a.isLog ? A(a.lin2log(d)) : d,
                    pos: g
                });
                if (H(b)) b && b.attr({text: v}); else {
                    if (this.label = b = H(v) && e.enabled ? u.renderer.text(v, 0, 0, e.useHTML).css(h(e.style)).add(a.labelGroup) : null) b.textPxLength = b.getBBox().width;
                    this.rotation = 0
                }
            }, getLabelSize: function () {
                return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0
            }, handleOverflow: function (a) {
                var n = this.axis, h = n.options.labels, b = a.x, d = n.chart.chartWidth, g = n.chart.spacing,
                    e = l(n.labelLeft, Math.min(n.pos, g[3])),
                    g = l(n.labelRight, Math.max(n.isRadial ? 0 : n.pos + n.len, d - g[1])), c = this.label,
                    m = this.rotation, f = {left: 0, center: .5, right: 1}[n.labelAlign || c.attr("align")],
                    r = c.getBBox().width, w = n.getSlotWidth(), K = w, z = 1, I, D = {};
                if (m || !1 === h.overflow) 0 > m && b - f * r < e ?
                    I = Math.round(b / Math.cos(m * t) - e) : 0 < m && b + f * r > g && (I = Math.round((d - b) / Math.cos(m * t))); else if (d = b + (1 - f) * r, b - f * r < e ? K = a.x + K * (1 - f) - e : d > g && (K = g - a.x + K * f, z = -1), K = Math.min(w, K), K < w && "center" === n.labelAlign && (a.x += z * (w - K - f * (w - Math.min(r, K)))), r > K || n.autoRotation && (c.styles || {}).width) I = K;
                ...
                return {
                    x: a ? d.translate(l + h, null, null, b) + d.transB : d.left +
                        d.offset + (d.opposite ? (b && g.oldChartWidth || g.chartWidth) - d.right - d.left : 0),
                    y: a ? e - d.bottom + d.offset - (d.opposite ? d.height : 0) : e - d.translate(l + h, null, null, b) - d.transB
                }
            }, getLabelPosition: function (a, l, h, b, d, g, e, c) {
                var m = this.axis, f = m.transA, r = m.reversed, w = m.staggerLines, n = m.tickRotCorr || {x: 0, y: 0},
                    z = d.y, u = b || m.reserveSpaceDefault ? 0 : -m.labelOffset * ("center" === m.labelAlign ? .5 : 1);
            ...
            }, getMarkPath: function (a, l, h, b, d, g) {
                return g.crispLine(["M", a, l, "L", a + (d ? 0 : -h), l + (d ? h : 0)], b)
            }, renderGridLine: function (a, l, h) {
                var b = this.axis, d = b.options, g = this.gridLine, e = {}, c = this.pos, m = this.type,
                    f = b.tickmarkOffset, r = b.chart.renderer, w = m ? m + "Grid" : "grid", n = d[w + "LineWidth"],
                    z = d[w + "LineColor"], d = d[w + "LineDashStyle"];
                ...
                if (!a && g && (a = b.getPlotLinePath(c + f, g.strokeWidth() * h, a, !0))) g[this.isNew ? "attr" : "animate"]({
                    d: a,
                    opacity: l
                })
            }, renderMark: function (a, h, u) {
                var b = this.axis, d = b.options, g = b.chart.renderer, e = this.type, c = e ? e + "Tick" : "tick",
                    m = b.tickSize(c), f = this.mark, r = !f, w = a.x;
                a = a.y;
                var n = l(d[c + "Width"], !e && b.isXAxis ? 1 : 0), d = d[c + "Color"];
                m && (b.opposite && (m[0] = -m[0]), r && (this.mark =
                    f = g.path().addClass("highcharts-" + (e ? e + "-" : "") + "tick").add(b.axisGroup), f.attr({
                    stroke: d,
                    "stroke-width": n
                })), f[r ? "attr" : "animate"]({
                    d: this.getMarkPath(w, a, m[0], f.strokeWidth() * u, b.horiz, g),
                    opacity: h
                }))
            }, renderLabel: function (a, h, u, b) {
                var d = this.axis, g = d.horiz, e = d.options, c = this.label, m = e.labels, f = m.step,
                    d = d.tickmarkOffset, r = !0, w = a.x;
                a = a.y;
                ...
                var b = this.axis, d = b.horiz, g = this.getPosition(d, this.pos, b.tickmarkOffset, h), e = g.x,
                    c = g.y, b = d && e === b.pos + b.len || !d && c === b.pos ? -1 : 1;
                u = l(u, 1);
                this.isActive = !0;
                this.renderGridLine(h, u, b);
                this.renderMark(g, u, b);
                this.renderLabel(g, h, u, a);
                this.isNew = !1
            }, destroy: function () {
                F(this, this.axis)
            }
    ...
    var V = function (a) {
        var A = a.addEvent, H = a.animObject, F = a.arrayMax, q = a.arrayMin, h = a.color, l = a.correctFloat,
            t = a.defaultOptions, n = a.defined, v = a.deg2rad, u = a.destroyObjectProperties, b = a.each, d = a.extend,
            g = a.fireEvent, e = a.format, c = a.getMagnitude, m = a.grep, f = a.inArray, r = a.isArray, w = a.isNumber,
            K = a.isString, z = a.merge, I = a.normalizeTickInterval, D = a.objectEach, C = a.pick, y = a.removeEvent,
            G = a.splat, B = a.syncTimeout, J = a.Tick, E = function () {
                this.init.apply(this, arguments)
            };
        a.extend(E.prototype, {
            ...
            defaultLabelFormatter: function () {
                var k = this.axis, b = this.value, c = k.chart.time, f = k.categories, d = this.dateTimeLabelFormat,
                    m = t.lang, r = m.numericSymbols, m = m.numericSymbolMagnitude || 1E3, y = r && r.length, g,
                    w = k.options.labels.format, k = k.isLog ?
                    Math.abs(b) : k.tickInterval;
                if (w) g = e(w, this, c); else if (f) g = b; else if (d) g = c.dateFormat(d, b); else if (y && 1E3 <= k) for (; y-- && void 0 === g;) c = Math.pow(m, y + 1), k >= c && 0 === 10 * b % c && null !== r[y] && 0 !== b && (g = a.numberFormat(b / c, -1) + r[y]);
            ...
            getPlotLinePath: function (a, b, c, e, f) {
                var k = this.chart, p = this.left, d = this.top, m, r, y = c && k.oldChartHeight || k.chartHeight,
                    g = c && k.oldChartWidth || k.chartWidth, N;
                m = this.transB;
                var B = function (a, k, b) {
                    if (a < k || a > b) e ? a = Math.min(Math.max(k, a), b) : N = !0;
                    return a
                };
            ...
            getMinorTickPositions: function () {
                var a = this, p = a.options, c = a.tickPositions,
                    e = a.minorTickInterval, f = [], d = a.pointRangePadding || 0, m = a.min - d, d = a.max + d,
                    r = d - m;
                if (r && r / e < a.len / 3) if (a.isLog) b(this.paddedTicks, function (k, b, p) {
                    b && f.push.apply(f, a.getLogTickPositions(e, p[b - 1], p[b], !0))
                }); else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) f = f.concat(a.getTimeTicks(a.normalizeTimeTickInterval(e), m, d, p.startOfWeek)); else for (p = m + (c[0] - m) % e; p <= d && p !== f[0]; p += e) f.push(p);
                0 !== f.length && a.trimTicks(f);
                return f
            },
            adjustForMinRange: function () {
                var a = this.options, p = this.min, c = this.max,
                    e, f, d, m, r, y, g, w;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (n(a.min) || n(a.max) ? this.minRange = null : (b(this.series, function (a) {
                    y = a.xData;
                    for (m = g = a.xIncrement ? 1 : y.length - 1; 0 < m; m--) if (r = y[m] - y[m - 1], void 0 === d || r < d) d = r
            ...
            getClosest: function () {
                ...
                this.categories ? a = 1 : b(this.series, function (k) {
                    var b = k.closestPointRange, p = k.visible || !k.chart.options.chart.ignoreHiddenSeries;
                    !k.noSharedTooltip && n(b) && p && (a = n(a) ? Math.min(a, b) : b)
                });
                return a
            },
            nameToX: function (a) {
            ...
            updateNames: function () {
                var a = this, p = this.names, c = p.length;
                if (0 < c) {
                    ...
                    b(this.series || [], function (k) {
                        ...
                        b(k.points, function (b, p) {
                            var c;
                            b.options && (c = a.nameToX(b), void 0 !== c && c !== b.x && (b.x = c, k.xData[p] = c))
                        })
                    })
                }
            },
            setAxisTranslation: function (a) {
                var k =
                        this, c = k.max - k.min, e = k.axisPointRange || 0, f, d = 0, m = 0, r = k.linkedParent,
                    y = !!k.categories, g = k.transA, w = k.isXAxis;
                if (w || y || e) f = k.getClosest(), r ? (d = r.minPointOffset, m = r.pointRangePadding) : b(k.series, function (a) {
                    var b = y ? 1 : w ? C(a.options.pointRange, f, 0) : k.axisPointRange || 0;
                    a = a.options.pointPlacement;
                    e = Math.max(e, b);
                    k.single || (d = Math.max(d, K(a) ? 0 : b / 2), m = Math.max(m, "on" === a ? 0 : b))
                }), r = k.ordinalSlope && f ? k.ordinalSlope / f : 1, k.minPointOffset = d *= r, k.pointRangePadding = m *= r, k.pointRange = Math.min(e, c), w && (k.closestPointRange =
                    f);
                a && (k.oldTransA = g);
            ...
            setTickInterval: function (k) {
                var p = this, e = p.chart, f = p.options, d = p.isLog, m = p.log2lin, r = p.isDatetimeAxis,
                    y = p.isXAxis, B = p.isLinked, G = f.maxPadding, h = f.minPadding, z = f.tickInterval,
                    D = f.tickPixelInterval, J = p.categories, E = p.threshold, u = p.softThreshold, t, v, q, K;
                ...
                y && !k && b(p.series, function (a) {
                    a.processData(p.min !== p.oldMin || p.max !== p.oldMax)
                });
            ...
            trimTicks: function (a, b, c) {
                var k = a[0], e = a[a.length - 1], p = this.minPointOffset || 0;
                if (!this.isLinked) {
                    if (b && -Infinity !== k) this.min = k; else for (; this.min - p > a[0];) a.shift();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, b = this.tickPositions, c = this.tickAmount, e = this.finalTickAmt,
                    ...
                    this.softThreshold ? 0 : null);
                if (this.hasData()) {
                    if (f < c) {
                        for (; b.length < c;) b.length % 2 || this.min === d ? b.push(l(b[b.length - 1] + a)) : b.unshift(l(b[0] - a));
                        this.transA *= (f - 1) / (c - 1);
                        this.min = b[0];
            ...
            setExtremes: function (a, c, e, f, m) {
                var k = this, p = k.chart;
                e = C(e, !0);
                b(k.series, function (a) {
                    delete a.kdTree
                });
                m = d(m, {min: a, max: c});
                g(k, "setExtremes", m, function () {
                    k.userMin = a;
                    k.userMax = c;
                    k.eventArgs = m;
                    e && p.redraw(f)
            ...
            zoom: function (a, b) {
                var k = this.dataMin, c = this.dataMax, e = this.options, f = Math.min(k, C(e.min, k)),
                    e = Math.max(c, C(e.max, c));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (n(k) && (a < f && (a = f), a > e && (a = e)), n(c) && (b < f && (b = f), b > e && (b = e))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a,
                    b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var b = this.chart, c = this.options, e = c.offsets || [0, 0, 0, 0], f = this.horiz,
                    d = this.width = Math.round(a.relativeLength(C(c.width, b.plotWidth - e[3] + e[1]), b.plotWidth)),
                    m = this.height = Math.round(a.relativeLength(C(c.height, b.plotHeight - e[0] + e[2]), b.plotHeight)),
                    r = this.top = Math.round(a.relativeLength(C(c.top, b.plotTop + e[0]), b.plotHeight, b.plotTop)),
                    c = this.left = Math.round(a.relativeLength(C(c.left, b.plotLeft + e[3]), b.plotWidth, b.plotLeft));
                this.bottom =
                    b.chartHeight - m - r;
            ...
            getThreshold: function (a) {
                var b = this.isLog, k = this.lin2log, c = b ? k(this.min) : this.min, b = b ? k(this.max) : this.max;
                null === a ? a = c : c > a ? a = c : b < a && (a = b);
                return this.translate(a, 0, 1, 0, 1)
            },
            autoLabelAlign: function (a) {
                a = (C(a,
                    0) - 90 * this.side + 720) % 360;
                return 15 < a && 165 > a ? "right" : 195 < a && 345 > a ? "left" : "center"
            },
            tickSize: function (a) {
                var b = this.options, k = b[a + "Length"], c = C(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
                if (c && k) return "inside" === b[a + "Position"] && (k = -k), [k, c]
            },
            ...
            unsquish: function () {
                var a = this.options.labels, c =
                        this.horiz, e = this.tickInterval, f = e,
                    d = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), m, r = a.rotation,
                    y = this.labelMetrics(), g, w = Number.MAX_VALUE, B, G = function (a) {
                        a /= d || 1;
                        a = 1 < a ? Math.ceil(a) : 1;
                        return a * e
                    };
                c ? (B = !a.staggerLines && !a.step && (n(r) ? [r] : d < C(a.autoRotationLimit, 80) && a.autoRotation)) && b(B, function (a) {
                    var b;
                    if (a === r || a && -90 <= a && 90 >= a) g = G(Math.abs(y.h / Math.sin(v * a))), b = g + Math.abs(a / 360), b < w && (w = b, m = a, f = g)
                }) : a.step || (f = G(y.h));
                this.autoRotation = B;
            ...
            getSlotWidth: function () {
                var a =
                    ...
                    e = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), f = a.margin[3];
            ...
            renderUnsquish: function () {
                var a = this.chart, c = a.renderer, e = this.tickPositions, f = this.ticks, d = this.options.labels,
                    m = this.horiz, r = this.getSlotWidth(), y = Math.max(1, Math.round(r - 2 * (d.padding || 5))),
                    g = {}, w = this.labelMetrics(), B = d.style &&
                ...
                if (this.autoRotation) h > y && h > w.h ? g.rotation = this.labelRotation : this.labelRotation = 0; else if (r && (G = y, !B)) for (l = "clip", y = e.length; !m && y--;) if (z = e[y], z = f[z].label) z.styles && "ellipsis" === z.styles.textOverflow ? z.css({textOverflow: "clip"}) : z.textPxLength > r && z.css({width: r + "px"}), z.getBBox().height > this.len / e.length - (w.h - w.f) &&
                (z.specificTextOverflow = "ellipsis");
                g.rotation && (G = h > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight, B || (l = "ellipsis"));
                if (this.labelAlign = d.align || this.autoLabelAlign(this.labelRotation)) g.align = this.labelAlign;
                b(e, function (a) {
                    var b = (a = f[a]) && a.label;
                    b && (b.attr(g), !G || d.style && d.style.width || !(G < b.textPxLength || "SPAN" === b.element.tagName) || b.css({
                        width: G,
            ...
            addTitle: function (a) {
                ...
                this.axisTitle || ((f = e.textAlign) || (f = (k ? {
                    low: "left",
                    middle: "center",
                    high: "right"
                } : {
            ...
            getOffset: function () {
                var a = this, c = a.chart, e = c.renderer, f = a.options, d = a.tickPositions, m = a.ticks, r = a.horiz,
                    y = a.side, g = c.inverted && !a.isZAxis ? [1, 0, 3, 2][y] : y, w, B, G = 0, l, h = 0, z = f.title,
                    E = f.labels, J = 0, u = c.axisOffset, c = c.clipOffset, t = [-1, 1, 1, -1][y], I = f.className,
                    q = a.axisParent, K = this.tickSize("tick");
                w = a.hasData();
                ...
                w || a.isLinked ? (b(d, function (b,
                                                  c) {
                    a.generateTick(b, c)
                }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === y || 2 === y || {
                    1: "left",
                    3: "right"
                }[y] === a.labelAlign, C(E.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && b(d, function (a) {
                    J = Math.max(m[a].getLabelSize(), J)
                }), a.staggerLines && (J *= a.staggerLines), a.labelOffset = J * (a.opposite ? -1 : 1)) : D(m, function (a, b) {
                    a.destroy();
                    delete m[b]
                });
            ...
            getTitlePosition: function () {
                var a = this.horiz, b = this.left, c = this.top,
                    e = this.len, f = this.options.title, d = a ? b : c, m = this.opposite, r = this.offset,
                    y = f.x || 0, g = f.y || 0, w = this.axisTitle,
                    B = this.chart.renderer.fontMetrics(f.style && f.style.fontSize, w),
                    w = Math.max(w.getBBox(null, 0).height - B.h - 1, 0),
                    e = {low: d + (a ? 0 : e), middle: d + e / 2, high: d + (a ? e : 0)}[f.align],
                    b = (a ? c + this.height : b) + (a ? 1 : -1) * (m ? -1 : 1) * this.axisTitleMargin + [-w, w, B.f, -w][this.side];
                return {
                    x: a ? e + y : b + (m ? this.width : 0) + r + y,
                    y: a ? b + g - (m ? this.height : 0) + r : e + g
                }
            },
            renderMinorTick: function (a) {
                var b = this.chart.hasRendered && w(this.oldMin), c =
                    this.minorTicks;
            ...
            renderTick: function (a, b) {
                var c = this.isLinked, e = this.ticks, k = this.chart.hasRendered && w(this.oldMin);
                if (!c || a >= this.min && a <= this.max) e[a] || (e[a] = new J(this, a)), k && e[a].isNew && e[a].render(b, !0, .1), e[a].render(b)
            },
            render: function () {
                var c = this, e = c.chart, f = c.options, d = c.isLog, m = c.lin2log, r = c.isLinked,
                    y = c.tickPositions, g = c.axisTitle, G = c.ticks, l = c.minorTicks, h = c.alternateBands,
                    z = f.stackLabels, n =
                        f.alternateGridColor, E = c.tickmarkOffset, C = c.axisLine, u = c.showAxis,
                    t = H(e.renderer.globalAnimation), I, q;
                ...
                if (c.hasData() || r) c.minorTickInterval && !c.categories && b(c.getMinorTickPositions(), function (a) {
                    c.renderMinorTick(a)
                }), y.length && (b(y, function (a, b) {
                    c.renderTick(a, b)
                }), E && (0 === c.min || c.single) && (G[-1] || (G[-1] = new J(c, -1, null, !0)), G[-1].render(-1))), n && b(y, function (b, k) {
                    q = void 0 !== y[k + 1] ? y[k + 1] + E : c.max - E;
                    0 === k %
                    2 && b < c.max && q <= c.max + (e.polar ? -E : E) && (h[b] || (h[b] = new a.PlotLineOrBand(c)), I = b + E, h[b].options = {
                        from: d ? m(I) : I,
                        to: d ? m(q) : q,
                        color: n
                    }, h[b].render(), h[b].isActive = !0)
                }), c._addedPlotLB || (b((f.plotLines || []).concat(f.plotBands || []), function (a) {
            ...
            destroy: function (a) {
                var c = this, e = c.stacks, k = c.plotLinesAndBands, d;
                a || y(c);
                D(e, function (a, b) {
                    u(a);
                    e[b] = null
    ...
    (function (a) {
        ...
        A.prototype.getLogTickPositions = function (a, t, n, v) {
            ...
            if (.5 <= a) a = Math.round(a), e = this.getLinearTickPositions(a, t, n); else if (.08 <= a) for (var b = Math.floor(t), c, m, f, r, w, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; b < n +
            1 && !w; b++) for (m = l.length, c = 0; c < m && !w; c++) f = g(d(b) * l[c]), f > t && (!v || r <= n) && void 0 !== r && e.push(r), r > n && (w = !0), r = f; else t = d(t), n = d(n), a = v ? this.getMinorTickInterval() : l.tickInterval, a = h("auto" === a ? null : a, this._minorAutoInterval, l.tickPixelInterval / (v ? 5 : 1) * (n - t) / ((v ? b / this.tickPositions.length : b) || 1)), a = q(a, null, H(a)), e = F(this.getLinearTickPositions(a, t, n), g), v || (this._minorAutoInterval = a / 5);
    ...
    (function (a, A) {
        var H = a.arrayMax, F = a.arrayMin, q = a.defined, h = a.destroyObjectProperties, l = a.each, t = a.erase,
            n = a.merge, v = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var h = this, b = h.axis, d = b.horiz, g = h.options, e = g.label, c = h.label, m = g.to, f = g.from,
                    r = g.value, w = q(f) && q(m), l = q(r), z = h.svgElem, t = !z, D = [], C = g.color,
                    y = v(g.zIndex, 0), G = g.events, D = {
                        "class": "highcharts-plot-" + (w ? "band " : "line ") +
                        (g.className || "")
                    }, B = {}, J = b.chart.renderer, E = w ? "bands" : "lines", k = b.log2lin;
                b.isLog && (f = k(f), m = k(m), r = k(r));
                l ? (D = {
                    stroke: C,
                    "stroke-width": g.width
                }, g.dashStyle && (D.dashstyle = g.dashStyle)) : w && (C && (D.fill = C), g.borderWidth && (D.stroke = g.borderColor, D["stroke-width"] = g.borderWidth));
                B.zIndex = y;
                E += "-" + y;
                (C = b.plotLinesAndBandsGroups[E]) || (b.plotLinesAndBandsGroups[E] = C = J.g("plot-" + E).attr(B).add());
                t && (h.svgElem = z = J.path().attr(D).add(C));
                if (l) D = b.getPlotLinePath(r, z.strokeWidth()); else if (w) D = b.getPlotBandPath(f,
                    m, g); else return;
                t && D && D.length ? (z.attr({d: D}), G && a.objectEach(G, function (a, b) {
                    z.on(b, function (a) {
                        G[b].apply(h, [a])
                    })
                })) : z && (D ? (z.show(), z.animate({d: D})) : (z.hide(), c && (h.label = c = c.destroy())));
                e && q(e.text) && D && D.length && 0 < b.width && 0 < b.height && !D.flat ? (e = n({
                    align: d && w && "center",
                    x: d ? !w && 4 : 10,
                    verticalAlign: !d && w && "middle",
                    y: d ? w ? 16 : 10 : w ? 6 : -4,
                    rotation: d && !w && 90
                }, e), this.renderLabel(e, D, w, y)) : c && c.hide();
                return h
                ...
                }, e.zIndex = g, this.label = e = c.text(a.text, 0, 0, a.useHTML).attr(e).add(), e.css(a.style));
        ...
        a.extend(A.prototype, {
            getPlotBandPath: function (a, b) {
                var d = this.getPlotLinePath(b, null,
                    null, !0), g = this.getPlotLinePath(a, null, null, !0), e = [], c = this.horiz, m = 1, f;
                a = a < this.min && b < this.min || a > this.max && b > this.max;
                if (g && d) for (a && (f = g.toString() === d.toString(), m = 0), a = 0; a < g.length; a += 6) c && d[a + 1] === g[a + 1] ? (d[a + 1] += m, d[a + 4] += m) : c || d[a + 2] !== g[a + 2] || (d[a + 2] += m, d[a + 5] += m), e.push("M", g[a + 1], g[a + 2], "L", g[a + 4], g[a + 5], d[a + 4], d[a + 5], d[a + 1], d[a + 2], "z"), e.flat = f;
                return e
            ...
            addPlotBandOrLine: function (h, b) {
                var d = (new a.PlotLineOrBand(this, h)).render(), g = this.userOptions;
                d && (b && (g[b] = g[b] || [], g[b].push(h)), this.plotLinesAndBands.push(d));
                return d
            }, removePlotBandOrLine: function (a) {
                for (var b = this.plotLinesAndBands, d = this.options, g = this.userOptions, e = b.length; e--;) b[e].id === a && b[e].destroy();
                l([d.plotLines || [], g.plotLines || [], d.plotBands || [], g.plotBands || []], function (b) {
    ...
    (function (a) {
        var A = a.each, H = a.extend, F = a.format, q = a.isNumber, h = a.map, l = a.merge, t = a.pick, n = a.splat,
        ...
        a.Tooltip.prototype = {
            init: function (a, d) {
                ...
                this.destroy();
                l(!0, this.chart.options.tooltip.userOptions,
                    a);
            ...
            }, move: function (a, d, g, e) {
                var b = this, m = b.now,
                    f = !1 !== b.options.animation && !b.isHidden && (1 < Math.abs(a - m.x) || 1 < Math.abs(d - m.y)),
                    r = b.followPointer || 1 < b.len;
                H(m, {
                    x: f ? (2 * m.x + a) / 3 : a,
                    y: f ? (m.y + d) / 2 : d,
                    anchorX: r ? void 0 : f ? (2 * m.anchorX + g) / 3 : g,
                    anchorY: r ? void 0 : f ?
                        (m.anchorY + e) / 2 : e
                });
                b.getLabel().attr(m);
                ...
                b || (A(a, function (a) {
                    l = a.series.yAxis;
                    z = a.series.xAxis;
                    r += a.plotX + (!c && z ? z.left - f : 0);
                    w += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!c && l ? l.top - m : 0)
                }), r /= a.length, w /= a.length, b = [c ? e.plotWidth - w : r, this.shared && !c && 1 < a.length && d ? d.chartY - m : c ? e.plotHeight - r : w]);
                return h(b, Math.round)
            }, getPosition: function (a, d, g) {
                var b = this.chart, c = this.distance, m = {}, f = b.inverted && g.h || 0, r,
                    w = ["y", b.chartHeight, d, g.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight],
                    h = ["x", b.chartWidth, a, g.plotX + b.plotLeft, b.plotLeft, b.plotLeft + b.plotWidth],
                    l = !this.followPointer && t(g.ttBelow, !b.inverted === !!g.negative),
                    n = function (a, b, e, d, k, p) {
                        var r = e < d - c, y = d + c + e < b, g = d - c - e;
                        d += c;
                        if (l && y) m[a] = d; else if (!l && r) m[a] = g; else if (r) m[a] = Math.min(p - e, 0 > g - f ? g : g - f); else if (y) m[a] = Math.max(k, d + f + e > b ? d : d + f); else return !1
                    }, D = function (a, b, e, f) {
                        var k;
                        f < c || f > b - c ? k = !1 : m[a] = f < e / 2 ? 1 : f > b - e / 2 ? b - e - 2 : f - e / 2;
                        return k
                    }, C = function (a) {
                        var b = w;
                        w = h;
                ...
                var b = this.points || n(this), g;
                g = [a.tooltipFooterHeaderFormatter(b[0])];
                g = g.concat(a.bodyFormatter(b));
                g.push(a.tooltipFooterHeaderFormatter(b[0], !0));
                return g
            }, refresh: function (a, d) {
                var b, e = this.options, c, m = a, f, r = {}, w = [];
                b = e.formatter || this.defaultFormatter;
                var r = this.shared, h;
                e.enabled && (clearTimeout(this.hideTimer), this.followPointer = n(m)[0].series.tooltipOptions.followPointer, f = this.getAnchor(m,
                    d), d = f[0], c = f[1], !r || m.series && m.series.noSharedTooltip ? r = m.getLabelConfig() : (A(m, function (a) {
                    a.setState("hover");
                    ...
                    t(m.colorIndex, h.colorIndex)), b.attr({stroke: e.borderColor || m.color || h.color || "#666666"}), this.updatePosition({
                    plotX: d,
                    plotY: c,
                    negative: m.negative,
                    ttBelow: m.ttBelow,
                ...
                var g = this, e = [], c = this.chart, m = c.renderer, f = !0, r = this.options, w = 0,
                    h = this.getLabel();
                a.isString(b) && (b = [!1, b]);
                A(b.slice(0, d.length + 1), function (a, b) {
                    if (!1 !== a) {
                        b = d[b - 1] || {isHeader: !0, plotX: d[0].plotX};
                        var l = b.series || g, z = l.tt, y = b.series || {}, G = "highcharts-color-" + t(b.colorIndex,
                            y.colorIndex, "none");
                        z || (l.tt = z = m.label(null, null, null, "callout", null, null, r.useHTML).addClass("highcharts-tooltip-box " + G).attr({
                            padding: r.padding,
                            r: r.borderRadius,
                            fill: r.backgroundColor,
                            stroke: r.borderColor || b.color || y.color || "#333333",
                        ...
                        a -= c.plotTop;
                        e.push({
                            target: b.isHeader ? c.plotHeight + w : a,
                            rank: b.isHeader ? 1 : 0,
                ...
                A(e, function (a) {
                    ...
                    a.tt.attr({
                        ...
                        x: f || b.isHeader ? a.x : b.plotX + c.plotLeft + t(r.distance, 16),
                        y: a.pos + c.plotTop,
                ...
                var b = this.chart, g = this.getLabel(),
                    g = (this.options.positioner || this.getPosition).call(this, g.width, g.height, a);
                this.move(Math.round(g.x), Math.round(g.y || 0), a.plotX + b.plotLeft, a.plotY + b.plotTop)
            }, getDateFormat: function (a, d, g, e) {
                var b = this.chart.time, m = b.dateFormat("%m-%d %H:%M:%S.%L", d), f, r,
                    w = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, h = "millisecond";
                for (r in u) {
                    ...
                    if (w[r] && m.substr(w[r]) !== "01-01 00:00:00.000".substr(w[r])) break;
                    "week" !== r && (h = r)
                }
                r && (f = e[r]);
                return f
                ...
                d = d ? "footer" : "header";
                var b = a.series, e = b.tooltipOptions, c = e.xDateFormat, m = b.xAxis,
                    f = m && "datetime" === m.options.type && q(a.key), r = e[d + "Format"];
                f && !c && (c = this.getXDateFormat(a,
                    e, m));
                f && c && A(a.point && a.point.tooltipDateKeys || ["key"], function (a) {
    ...
    (function (a) {
        var A = a.addEvent, H = a.attr, F = a.charts, q = a.color, h = a.css, l = a.defined, t = a.each, n = a.extend,
            v = a.find,
            u = a.fireEvent, b = a.isNumber, d = a.isObject, g = a.offset, e = a.pick, c = a.splat, m = a.Tooltip;
        ...
        a.Pointer.prototype = {
            init: function (a, b) {
                ...
                t(a, function (a) {
                    ...
                    a = a.searchPoint(c, f);
                    if ((f = d(a, !0)) && !(f = !d(e, !0))) var f = e.distX - a.distX, m = e.dist - a.dist,
                        r = (a.series.group && a.series.group.zIndex) - (e.series.group && e.series.group.zIndex),
                        f = 0 < (0 !== f && b ? f : 0 !== m ? m : 0 !== r ? r : e.series.index > a.series.index ? -1 : 1);
                    f && (e = a)
                });
                return e
                ...
                var c = a.series, f = c.xAxis, c = c.yAxis, d = e(a.clientX, a.plotX);
                if (f && c) return b ? {
                    chartX: f.len + f.pos - d,
                    chartY: c.len + c.pos - a.plotY
                } : {chartX: d + f.pos, chartY: a.plotY + c.pos}
            }, getHoverData: function (b, c, m, g, h, l, n) {
                var f, y = [], r = n && n.isBoosting;
                g = !(!g || !b);
                n = c && !c.stickyTracking ? [c] : a.grep(m, function (a) {
                    return a.visible && !(!h && a.directTouch) && e(a.options.enableMouseTracking, !0) && a.stickyTracking
                });
                c = (f = g ? b : this.findNearestKDPoint(n, h, l)) && f.series;
                f && (h && !c.noSharedTooltip ?
                    (n = a.grep(m, function (a) {
                        return a.visible && !(!h && a.directTouch) && e(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                    }), t(n, function (a) {
                        var b = v(a.points, function (a) {
                            return a.x === f.x && !a.isNull
                        });
                        d(b) && (r && (b = a.getPoint(b)), y.push(b))
                    })) : y.push(f));
                ...
                var f = this.chart, d = f.tooltip && f.tooltip.options.enabled ? f.tooltip : void 0,
                    m = d ? d.shared : !1, r = c || f.hoverPoint, g = r && r.series || f.hoverSeries,
                    g = this.getHoverData(r, g, f.series, !!c ||
                        g && g.directTouch && this.isDirectTouch, m, b, {isBoosting: f.isBoosting}), h,
                    r = g.hoverPoint;
                h = g.hoverPoints;
                ...
                this.unDocMouseMove || (this.unDocMouseMove = A(f.container.ownerDocument, "mousemove", function (b) {
                    var c = F[a.hoverChartIndex];
                    if (c) c.pointer.onDocumentMouseMove(b)
                }));
                t(f.axes, function (c) {
                    var f = e(c.crosshair.snap, !0), d = f ? a.find(h, function (a) {
                ...
                var e = this.chart, f = e.hoverSeries, d = e.hoverPoint,
                    m = e.hoverPoints, g = e.tooltip, r = g && g.shared ? m : d;
                a && r && t(c(r), function (b) {
                    b.series.isCartesian && void 0 === b.plotX && (a = !1)
                });
                if (a) g && r && (g.refresh(r), d && (d.setState(d.state, !0), t(e.axes, function (a) {
                ...
                var b = this.chart, c = b.options.chart, e = a.chartX, f = a.chartY,
                    d = this.zoomHor, m = this.zoomVert, g = b.plotLeft, y = b.plotTop, h = b.plotWidth,
                    l = b.plotHeight, n, E = this.selectionMarker, k = this.mouseDownX, p = this.mouseDownY,
                    t = c.panKey && a[c.panKey + "Key"];
                E && E.touch || (e < g ? e = g : e > g + h && (e = g + h), f < y ? f = y : f > y + l && (f = y + l), this.hasDragged = Math.sqrt(Math.pow(k - e, 2) + Math.pow(p - f, 2)), 10 < this.hasDragged && (n = b.isInsidePlot(k - g, p - y), b.hasCartesianSeries && (this.zoomX || this.zoomY) && n && !t && !E && (this.selectionMarker = E = b.renderer.rect(g, y, d ? 1 : h, m ? 1 : l, 0).attr({
                ...
                if (this.selectionMarker) {
                    var d = {originalEvent: a, xAxis: [], yAxis: []}, m = this.selectionMarker,
                        g = m.attr ? m.attr("x") : m.x, C = m.attr ? m.attr("y") : m.y,
                        y = m.attr ? m.attr("width") : m.width, G = m.attr ? m.attr("height") : m.height, B;
                    if (this.hasDragged || f) t(e.axes,
                        function (b) {
                            if (b.zoomEnabled && l(b.min) && (f || c[{xAxis: "zoomX", yAxis: "zoomY"}[b.coll]])) {
                                var e = b.horiz, k = "touchend" === a.type ? b.minPixelPadding : 0,
                                    m = b.toValue((e ? g : C) + k), e = b.toValue((e ? g + y : C + G) - k);
                                d[b.coll].push({axis: b, min: Math.min(m, e), max: Math.max(m, e)});
                                B = !0
                            }
                        }), B && u(e, "selection", d, function (a) {
                        e.zoom(n(a, f ? {animation: !1} : null))
                    });
            ...
            onContainerMouseLeave: function (b) {
                ...
                var c = this.chart;
                l(a.hoverChartIndex) && F[a.hoverChartIndex] && F[a.hoverChartIndex].mouseIsDown || (a.hoverChartIndex = c.index);
                b = this.normalize(b);
                b.returnValue = !1;
            ...
            inClass: function (a, b) {
                ...
                var b = this.chart, c = b.hoverPoint, e = b.plotLeft,
                    f = b.plotTop;
                a = this.normalize(a);
    ...
    (function (a) {
        ...
        F(a.Pointer.prototype, {
            pinchTranslate: function (a, h, l, q, b, d) {
                this.zoomHor && this.pinchTranslateDirection(!0, a, h, l, q, b, d);
                this.zoomVert && this.pinchTranslateDirection(!1, a, h, l, q, b, d)
            }, pinchTranslateDirection: function (a, h, l, q, b, d, g, e) {
                var c = this.chart,
                    m = a ? "x" : "y", f = a ? "X" : "Y", r = "chart" + f, w = a ? "width" : "height",
                    n = c["plot" + (a ? "Left" : "Top")], z, t, D = e || 1, C = c.inverted, y = c.bounds[a ? "h" : "v"],
                    G = 1 === h.length, B = h[0][r], J = l[0][r], E = !G && h[1][r], k = !G && l[1][r], p;
                l = function () {
                    !G && 20 < Math.abs(B - E) && (D = e || Math.abs(J - k) / Math.abs(B - E));
                    t = (n - J) / D + B;
                    z = c["plot" + (a ? "Width" : "Height")] / D
                };
                l();
                h = t;
                ...
                var n = this, t = n.chart, u = n.pinchDown, b = a.touches, d = b.length, g = n.lastValidTouch,
                    e = n.hasZoom, c = n.selectionMarker, m = {},
                    f = 1 === d && (n.inClass(a.target, "highcharts-tracker") && t.runTrackerClick || n.runChartClick),
                    r = {};
                1 < d && (n.initiated = !0);
                ...
                }), g.x = [u[0].chartX, u[1] && u[1].chartX], g.y = [u[0].chartY,
                    u[1] && u[1].chartY], H(t.axes, function (a) {
                    if (a.zoomEnabled) {
                        var b = t.bounds[a.horiz ? "h" : "v"], c = a.minPixelPadding,
                            e = a.toPixels(l(a.options.min, a.dataMin)), d = a.toPixels(l(a.options.max, a.dataMax)),
                            f = Math.max(e, d);
                        b.min = Math.min(a.pos, Math.min(e, d) - c);
                        b.max = Math.max(a.pos + a.len, f + c)
                    }
                }), n.res = !0) : n.followTouchMove && 1 === d ? this.runPointActions(n.normalize(a)) : u.length && (c || (n.selectionMarker = c = F({
                    destroy: h,
                    touch: !0
                }, t.plotBox)), n.pinchTranslate(u, b, m, c, r, g), n.hasPinched = e, n.scaleGroups(m, r), n.res && (n.res =
                    !1, this.reset(!1, 0)))
            }, touch: function (h, n) {
                ...
                A[a.hoverChartIndex] && A[a.hoverChartIndex].pointer.drop(h)
            }
        })
    })(L);
    (function (a) {
        var A = a.addEvent, H = a.charts, F = a.css, q = a.doc, h = a.extend, l = a.noop, t = a.Pointer,
        ...
        if (!a.hasTouch && (v.PointerEvent || v.MSPointerEvent)) {
            var b = {}, d = !!v.PointerEvent, g = function () {
                ...
                "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !H[a.hoverChartIndex] || (h(b), h = H[a.hoverChartIndex].pointer, h[e]({
                    type: d,
            ...
            h(t.prototype, {
                onContainerPointerDown: function (a) {
                    e(a, "onContainerTouchStart", "touchstart", function (a) {
                        b[a.pointerId] = {pageX: a.pageX, pageY: a.pageY, target: a.currentTarget}
                    })
                }, onContainerPointerMove: function (a) {
                    e(a,
                        "onContainerTouchMove", "touchmove", function (a) {
                            b[a.pointerId] = {pageX: a.pageX, pageY: a.pageY};
    ...
    (function (a) {
        var A = a.addEvent, H = a.css, F = a.discardElement, q = a.defined, h = a.each, l = a.isFirefox,
            t = a.marginNames, n = a.merge, v = a.pick, u = a.setAnimation, b = a.stableSort, d = a.win, g = a.wrap;
        ...
        a.Legend.prototype = {
            init: function (a, b) {
                ...
                var c = this.options, e = a.legendItem, d = a.legendLine, g = a.legendSymbol,
                    h = this.itemHiddenStyle.color, c = b ? c.itemStyle.color : h, l = b ? a.color || h : h,
                ...
                var b = this.options, e = b.symbolPadding, b = !b.rtl, d = a._legendItemPos, g = d[0], d = d[1],
                    h = a.checkbox;
                (a = a.legendGroup) && a.element && a.translate(b ? g : this.legendWidth - g - 2 * e - 4, d);
                h && (h.x = g, h.y = d)
                ...
                var a = this.group && this.group.alignAttr, b, d = this.clipHeight || this.legendHeight,
                    f = this.titleHeight;
                a && (b = a.translateY, h(this.allItems, function (c) {
                    var e = c.checkbox, m;
                    e && (m = b + f + e.y + (this.scrollOffset || 0) + 3, H(e, {
                        left: a.translateX + c.checkboxOffset + e.x - 20 + "px",
                        top: m + "px",
                        display: m > b - 6 && m < b + d - 6 ? "" : "none"
                    }))
                }, this))
                ...
                var b = this.chart, e = b.renderer, d =
                        this.options, g = "horizontal" === d.layout, h = this.symbolWidth, l = d.symbolPadding,
                    z = this.itemStyle, q = this.itemHiddenStyle, D = this.padding, C = g ? v(d.itemDistance, 20) : 0,
                    y = !d.rtl, G = d.width, B = d.itemMarginBottom || 0, J = this.itemMarginTop, E = a.legendItem,
                    k = !a.series, p = !k && a.series.drawLegendSymbol ? a.series : a, t = p.options,
                    u = this.createCheckboxForItem && t && t.showCheckbox, t = h + l + C + (u ? 20 : 0), N = d.useHTML,
                    P = a.options.className;
                E || (a.legendGroup = e.g("legend-item").addClass("highcharts-" + p.type + "-series highcharts-color-" + a.colorIndex +
                    (P ? " " + P : "") + (k ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = E = e.text("", y ? h + l : -l, this.baseline || 0, N).css(n(a.visible ? z : q)).attr({
                    align: y ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), this.baseline || (h = z.fontSize, this.fontMetrics = e.fontMetrics(h, E), this.baseline = this.fontMetrics.f + 3 + J, E.attr("y", this.baseline)), this.symbolHeight = d.symbolHeight || this.fontMetrics.f, p.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, E, N), u && this.createCheckboxForItem(a));
                ...
                d && h([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, m) {
                    f.test(d) && !q(a[m]) && (c[t[m]] = Math.max(c[t[m]], c.legend[(m + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][m] * e[m % 2 ? "x" : "y"] + v(e.margin, 12) + b[m] + (0 === m ? c.titleOffset + c.options.title.margin : 0)))
                })
            }, render: function () {
                var a = this, c = a.chart, d = c.renderer, f = a.group, g, l, q, z, t = a.box, D = a.options,
                    C = a.padding;
                a.itemX = C;
                ...
                0 < q && 0 < z && (t[t.isNew ? "attr" : "animate"](t.crisp.call({}, {
                    x: 0,
                    y: 0,
                    width: q,
                    height: z
                ...
                l && (d = c.spacingBox, /(lth|ct|rth)/.test(a.getAlignment()) && (d = n(d, {
                    y: d.y + c.titleOffset +
                    c.options.title.margin
                })), f.align(n(D, {width: q, height: z}), !0, d));
                c.isResizing || this.positionCheckboxes()
            }, handleOverflow: function (a) {
                var b = this, e = this.chart, d = e.renderer, g = this.options, l = g.y, n = this.padding,
                    e = e.spacingBox.height + ("top" === g.verticalAlign ? -l : l) - n, l = g.maxHeight, z,
                    q = this.clipRect, D = g.navigation, C = v(D.animation, !0), y = D.arrowSize || 12, G = this.nav,
                    B = this.pages, J, E = this.allItems, k = function (a) {
                ...
                a > e && !1 !== D.enabled ? (this.clipHeight = z = Math.max(e - 20 - this.titleHeight - n, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, h(E, function (a, b) {
                    ...
                    if (!d || c - B[d - 1] > z && (J || c) !== B[d - 1]) B.push(J || c), d++;
                    a.pageIx = d - 1;
                    J && (E[b - 1].pageIx = d - 1);
                    b === E.length - 1 && c + e - B[d - 1] > z && (B.push(c), a.pageIx = d);
                    c !== J && (J = c)
                }), q || (q = b.clipRect = d.clipRect(0, n, 9999, 0), b.contentGroup.clip(q)), k(z), G || (this.nav = G = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, y, y).on("click", function () {
                    b.scroll(-1, C)
                }).add(G), this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation").css(D.style).add(G), this.down = d.symbol("triangle-down", 0, 0, y, y).on("click", function () {
                    b.scroll(1, C)
                }).add(G)), b.scroll(0), a = e) : G && (k(), this.nav = G.destroy(), this.scrollGroup.attr({translateY: 1}),
                    this.clipHeight = 0);
                return a
            }, scroll: function (a, b) {
                ...
                0 < a && (void 0 !== b && u(b, this.chart), this.nav.attr({
                    ...
                    visibility: "visible"
                }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), h.attr({text: a + "/" + d}), this.down.attr({
                    x: 18 + this.pager.getBBox().width, "class": a === d ? "highcharts-legend-nav-inactive" :
                        "highcharts-legend-nav-active"
                }), this.up.attr({fill: 1 === a ? g.inactiveColor : g.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === d ? g.inactiveColor : g.activeColor}).css({cursor: a === d ? "default" : "pointer"}), this.scrollOffset = -c[a - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = a, this.positionCheckboxes())
            }
        };
        a.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                ...
                var b = this.options, d = b.marker, e = a.symbolWidth, g = a.symbolHeight, h = g / 2,
                ...
                d &&
                !1 !== d.enabled && (b = Math.min(v(d.radius, h), h), 0 === this.symbol.indexOf("url") && (d = n(d, {
                    width: g,
                    height: g
                }), b = 0), this.legendSymbol = d = l.symbol(this.symbol, e / 2 - b, a - b, 2 * b, 2 * b, d).addClass("highcharts-point").add(z), d.isMarker = !0)
            }
        };
        (/Trident\/7\.0/.test(d.navigator.userAgent) || l) && g(a.Legend.prototype, "positionItem", function (a, b) {
    ...
    (function (a) {
        var A = a.addEvent, H = a.animate, F = a.animObject, q = a.attr, h = a.doc, l = a.Axis, t = a.createElement,
            n = a.defaultOptions, v = a.discardElement, u = a.charts, b = a.css, d = a.defined, g = a.each,
            e = a.extend, c = a.find, m = a.fireEvent, f = a.grep, r = a.isNumber, w = a.isObject, K = a.isString,
            z = a.Legend, I = a.marginNames, D = a.merge, C = a.objectEach, y = a.Pointer, G = a.pick, B = a.pInt,
            J = a.removeEvent, E = a.seriesTypes, k = a.splat, p = a.syncTimeout, M = a.win, O = a.Chart = function () {
        ...
        e(O.prototype, {
            callbacks: [], getArgs: function () {
                ...
                if (K(a[0]) || a[0].nodeName) this.renderTo =
                    a.shift();
                this.init(a[0], a[1])
            }, init: function (b, c) {
                ...
                b.series = null;
                d = D(n, b);
                for (e in d.plotOptions) d.plotOptions[e].tooltip = f[e] && D(f[e].tooltip) || void 0;
            ...
            isInsidePlot: function (a, b, c) {
                ...
                var c = this.axes, d = this.series, k = this.pointer, f = this.legend, p = this.isDirtyLegend, h, y,
                    l = this.hasCartesianSeries, G = this.isDirtyBox, r, B = this.renderer, n = B.isHidden(), E = [];
                this.setResponsive && this.setResponsive(!1);
                a.setAnimation(b, this);
                n && this.temporaryDisplay();
                this.layOutTitles();
                for (b = d.length; b--;) if (r = d[b], r.options.stacking && (h = !0, r.isDirty)) {
                    y = !0;
                    break
                }
                if (y) for (b = d.length; b--;) r =
                ...
                var d, e = this.series, k;
                d = c(this.axes, b) || c(this.series, b);
                for (k = 0; !d && k < e.length; k++) d = c(e[k].points || [], b);
                return d
            }, getAxes: function () {
                ...
                g([["title", a, k], ["subtitle", b, e]], function (a, b) {
                    var c = a[0], e = d[c], k = a[1];
                    a = a[2];
                    e && k && (d[c] = e = e.destroy());
                ...
                var c = this, e = c.options.chart, k = c.renderTo,
                    f = d(e.width) && d(e.height), g = e.width || a.getStyle(k, "width"),
                    e = e.height || a.getStyle(k, "height"), k = b ? b.target : M;
                if (!f && !c.isPrinting && g && e && (k === M || k === h)) {
                    if (g !== c.containerWidth || e !== c.containerHeight) clearTimeout(c.reflowTimeout), c.reflowTimeout = p(function () {
                ...
                p(function () {
                    k &&
                    m(k, "endResize", null, function () {
                        --k.isResizing
                    })
                }, F(c).duration)
            }, setChartSize: function (a) {
                var b = this.inverted, c = this.renderer, d = this.chartWidth, k = this.chartHeight,
                    e = this.options.chart, f = this.spacing, m = this.clipOffset, p, h, y, l;
                ...
                this.clipBox = {
                    ...
                    height: Math.max(0, Math.floor(this.plotSizeY - Math.max(d, m[2]) / 2 - c))
                };
                ...
                g(["margin", "spacing"], function (c) {
                    var d = b[c], k = w(d) ? d : [d, d, d, d];
                    g(["Top", "Right", "Bottom", "Left"], function (d, e) {
                        a[c][e] = G(b[c + d], k[e])
                    })
                });
                g(I, function (b, c) {
                ...
                var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight,
                    k = this.chartBackground, e = this.plotBackground, f = this.plotBorder, g, m = this.plotBGImage,
                    p = a.backgroundColor, h = a.plotBackgroundColor, y = a.plotBackgroundImage, l, G = this.plotLeft,
                    r = this.plotTop, B = this.plotWidth, n = this.plotHeight, E = this.plotBox, z = this.clipRect,
                    q = this.clipBox, w = "animate";
                k || (this.chartBackground = k = b.rect().addClass("highcharts-background").add(), w = "attr");
                g = a.borderWidth || 0;
                l = g + (a.shadow ? 8 : 0);
                p = {fill: p || "none"};
                if (g || k["stroke-width"]) p.stroke = a.borderColor, p["stroke-width"] = g;
                ...
                var a = this, b =
                    a.options.chart, c, d = a.options.series, k, e;
                g(["inverted", "angular", "polar"], function (f) {
                    c = E[b.type || b.defaultSeriesType];
                    e = b[f] || c && c.prototype[f];
                    for (k = d && d.length; !e && k--;) (c = E[d[k].type]) && c.prototype[f] && (e = !0);
                    a[f] = e
                })
            }, linkSeries: function () {
                ...
                g(b, function (b) {
                    ...
                    K(c) && (c = ":previous" === c ? a.series[b.index - 1] : a.get(c)) && c.linkedParent !== b && (c.linkedSeries.push(b), b.linkedParent = c, b.visible = G(b.options.visible, c.options.visible,
                        b.visible))
                })
                ...
                b.items && g(b.items, function (c) {
                    var d = e(b.style, c.style), k = B(d.left) + a.plotLeft, f = B(d.top) + a.plotTop + 12;
                    delete d.left;
                    delete d.top;
                    a.renderer.text(c.html, k, f).attr({zIndex: 2}).css(d).add()
                })
            }, render: function () {
                ...
                var b = this, c = b.axes,
                    d = b.series, k = b.container, e, f = k && k.parentNode;
                m(b, "destroy");
    ...
    (function (a) {
        var A, H = a.each, F = a.extend, q = a.erase, h = a.fireEvent, l = a.format, t = a.isArray, n = a.isNumber,
        ...
        a.Point.prototype = {
            init: function (a, d, g) {
                ...
                var b = {}, g = this.series, e = g.options.keys, c = e || g.pointArrayMap || ["y"], m = c.length, f = 0,
                    h = 0;
                if (n(a) || null === a) b[c[0]] = a; else if (t(a)) for (!e && a.length > m && (g = typeof a[0], "string" === g ? b.name = a[0] : "number" === g && (b.x = a[0]), f++); h < m;) e && void 0 === a[f] || (b[c[h]] = a[f]), f++, h++; else "object" ===
                ...
                var a =
                    this.series, d = a.zones, a = a.zoneAxis || "y", g = 0, e;
                for (e = d[g]; this[a] >= e.value;) e = d[++g];
                ...
                for (var a = ["graphic",
                    "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], d, g = 6; g--;) d = a[g], this[d] && (this[d] = this[d].destroy())
                ...
                var b = this.series, g = b.tooltipOptions, e = v(g.valueDecimals, ""), c = g.valuePrefix || "",
                    m = g.valueSuffix || "";
    ...
    (function (a) {
        var A = a.addEvent, H = a.animObject, F = a.arrayMax, q = a.arrayMin,
            h = a.correctFloat, l = a.defaultOptions, t = a.defaultPlotOptions, n = a.defined, v = a.each, u = a.erase,
            b = a.extend, d = a.fireEvent, g = a.grep, e = a.isArray, c = a.isNumber, m = a.isString, f = a.merge,
            r = a.objectEach, w = a.pick, K = a.removeEvent, z = a.splat, I = a.SVGElement, D = a.syncTimeout,
            C = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            marker: {
                lineWidth: 0, lineColor: "#ffffff", enabledThreshold: 2, radius: 4, states: {
                    normal: {}, hover: {
                        animation: {duration: 50}, enabled: !0,
                        radiusPlus: 2, lineWidthPlus: 1
            ...
            insert: function (a) {
                ...
                if (c(b)) {
                    for (d = a.length; d--;) if (b >= w(a[d].options.index, a[d]._i)) {
                        a.splice(d + 1, 0, this);
                        break
                    }
                    -1 === d && a.unshift(this);
            ...
            updateParallelArrays: function (a, b) {
                var d = a.series, e = arguments, f = c(b) ? function (c) {
            ...
            setOptions: function (a) {
                var b = this.chart, c = b.options, d = c.plotOptions, e = (b.userOptions || {}).plotOptions || {},
                    k = d[this.type];
                this.userOptions =
                    a;
                b = f(k, d.series, a);
            ...
            getCyclic: function (a, b, c) {
                var d, e = this.chart, k = this.userOptions, f = a + "Index", g = a + "Counter",
            ...
            setData: function (b, d, f, g) {
                var h = this, k = h.points, p = k && k.length || 0, l, y = h.options, r =
                        h.chart, n = null, G = h.xAxis, B = y.turboThreshold, z = this.xData, q = this.yData,
                    D = (l = h.pointArrayMap) && l.length;
                b = b || [];
                l = b.length;
                d = w(d, !0);
                if (!1 !== g && l && p === l && !h.cropped && !h.hasGroupedData && h.visible) v(b, function (a, b) {
                    k[b].update && a !== y.data[b] && k[b].update(a, !1, null, !1)
                }); else {
                    h.xIncrement = null;
                    h.colorCounter = 0;
                    ...
                    if (B && l > B) {
                        for (f = 0; null === n && f < l;) n = b[f], f++;
                        if (c(n)) for (f = 0; f < l; f++) z[f] = this.autoIncrement(), q[f] = b[f]; else if (e(n)) if (D) for (f = 0; f < l; f++) n =
                            b[f], z[f] = n[0], q[f] = n.slice(1, D + 1); else for (f = 0; f < l; f++) n = b[f], z[f] = n[0], q[f] = n[1]; else a.error(12)
                    } else for (f = 0; f < l; f++) void 0 !== b[f] && (n = {series: h}, h.pointClass.prototype.applyOptions.apply(n, [b[f]]), h.updateParallelArrays(n, f));
                    q && m(q[0]) && a.error(14, !0);
                    h.data = [];
                    h.options.data = h.userOptions.data = b;
                    for (f = p; f--;) k[f] && k[f].destroy && k[f].destroy();
            ...
            processData: function (b) {
                ...
                h = l.cropThreshold;
                var y = this.getExtremesFromAll || l.getExtremesFromAll, r = this.isCartesian, l = m && m.val2lin,
                    n = m && m.isLog, z = this.requireSorting, q, w;
                if (r && !this.isDirty && !m.isDirty && !this.yAxis.isDirty && !b) return !1;
                m && (b = m.getExtremes(), q = b.min, w = b.max);
                if (r && this.sorted && !y && (!h || e > h || this.forceCrop)) if (c[e - 1] < q || c[0] > w) c = [], d = []; else if (c[0] < q || c[e - 1] > w) f = this.cropData(this.xData,
                    this.yData, q, w), c = f.xData, d = f.yData, f = f.start, k = !0;
                for (h = c.length || 1; --h;) e = n ? l(c[h]) - l(c[h - 1]) : c[h] - c[h - 1], 0 < e && (void 0 === g || e < g) ? g = e : 0 > e && z && (a.error(15), z = !1);
                this.cropped = k;
                this.cropStart = f;
            ...
            cropData: function (a, b, c, d) {
                var e = a.length, k = 0, f = e, g = w(this.cropShoulder, 1), m;
            ...
            generatePoints: function () {
                var a =
                        this.options, b = a.data, c = this.data, d, e = this.processedXData, k = this.processedYData,
                    f = this.pointClass, g = e.length, m = this.cropStart || 0, h, l = this.hasGroupedData, a = a.keys,
                    r, n = [], q;
                c || l || (c = [], c.length = b.length, c = this.data = c);
                a && l && (this.options.keys = !1);
                for (q = 0; q < g; q++) h = m + q, l ? (r = (new f).init(this, [e[q]].concat(z(k[q]))), r.dataGroup = this.groupMap[q]) : (r = c[h]) || void 0 === b[h] || (c[h] = r = (new f).init(this, b[h], e[q])), r && (r.index = h, n[q] = r);
                this.options.keys = a;
                if (c && (g !== (d = c.length) || l)) for (q = 0; q < d; q++) q !== m || l ||
            ...
            getExtremes: function (a) {
                ...
                f = a.length;
                for (n = 0; n < f; n++) if (y = d[n], r = a[n], l = (c(r, !0) || e(r)) && (!b.positiveValuesOnly || r.length || 0 < r), y = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[n + 1] || y) >= m && (d[n - 1] || y) <= h, l && y) if (l = r.length) for (; l--;) "number" ===
                typeof r[l] && (g[k++] = r[l]); else g[k++] = r;
                this.dataMin = q(g);
                this.dataMax = F(g)
            },
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, d = this.xAxis, e = d.categories, f = this.yAxis, k = this.points,
                    g = k.length, m = !!this.modifyValue, l = a.pointPlacement, r = "between" === l || c(l),
                    q = a.threshold, z = a.startFromThreshold ? q : 0, D, C, t, v, u = Number.MAX_VALUE;
                "between" === l && (l = .5);
                ...
                for (a = 0; a < g; a++) {
                    ...
                    C = I.low;
                    var F =
                        b && f.stacks[(this.negStacks && A < (z ? 0 : q) ? "-" : "") + this.stackKey], H;
            ...
            getValidPoints: function (a, b) {
                var c = this.chart;
                return g(a || this.points || [], function (a) {
                    return b && !c.isInsidePlot(a.plotX, a.plotY, c.inverted) ? !1 : !a.isNull
                })
            },
            setClip: function (a) {
                var b = this.chart, c = this.options, d = b.renderer, e = b.inverted, k = this.clipBox,
                    f = k || b.clipBox,
            ...
            animate: function (a) {
                ...
                a.animate({width: b.plotSizeX, x: 0}, c), b[d + "m"] && b[d + "m"].animate({
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, c, d, e, k, f = this.options.marker, g, m, h,
                    l = this[this.specialGroup] || this.markerGroup, r,
                    n = w(f.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= f.enabledThreshold * f.radius);
                if (!1 !== f.enabled || this._hasPointMarkers) for (c = 0; c < a.length; c++) d =
            ...
            markerAttribs: function (a, b) {
                var c = this.options.marker, d = a.marker || {},
                    e = d.symbol || c.symbol, k = w(d.radius, c.radius);
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker, d = a && a.options, e = d && d.marker || {}, k = this.color,
                    f = d && d.color, g = a && a.color, d = w(e.lineWidth, c.lineWidth);
            ...
            destroy: function () {
                var a = this, b = a.chart, c = /AppleWebKit\/533/.test(C.navigator.userAgent), e, f, k = a.data || [],
                    g, m;
                d(a, "destroy");
                K(a);
                ...
                for (f = k.length; f--;) (g = k[f]) && g.destroy && g.destroy();
                a.points = null;
            ...
            getGraphPath: function (a, b, c) {
                ...
                v(a, function (f, l) {
                    var p = f.plotX, r = f.plotY, y = a[l - 1];
                    (f.leftCliff || y && y.rightCliff) && !c && (h = !0);
                    f.isNull && !n(b) && 0 < l ? h = !e.connectNulls : f.isNull && !b ? h = !0 : (0 === l || h ? l = ["M", f.plotX, f.plotY] : d.getPointSpline ? l = d.getPointSpline(a, f, l) : k ? (l = 1 === k ? ["L", y.plotX, r] : 2 === k ? ["L", (y.plotX + p) / 2, y.plotY, "L", (y.plotX + p) / 2, r] : ["L", p, y.plotY], l.push("L", p, r)) : l = ["L", p, r], m.push(f.x), k && m.push(f.x), g.push.apply(g, l), h = !1)
                });
                g.xMap = m;
            ...
            drawGraph: function () {
                ...
                v(d, function (d, e) {
                    var k = d[0], f = a[k];
                    f ? (f.endX = a.preventGraphAnimation ? null : c.xMap, f.animate({d: c})) : c.length && (a[k] = a.chart.renderer.path(c).addClass(d[1]).attr({zIndex: 1}).add(a.group), f = {
                        stroke: d[2], "stroke-width": b.lineWidth, fill: a.fillGraph &&
                        a.color || "none"
                    }, d[3] ? f.dashstyle = d[3] : "square" !== b.linecap && (f["stroke-linecap"] = f["stroke-linejoin"] = "round"), f = a[k].attr(f).shadow(2 > e && b.shadow));
                    f && (f.startX = c.xMap, f.isArea = c.isArea)
                })
            },
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer, d = this.zones, e, k, f = this.clips || [], g,
                    m = this.graph, h = this.area, l = Math.max(b.chartWidth, b.chartHeight),
                    r = this[(this.zoneAxis || "y") + "Axis"], n, q, z = b.inverted, D, C, t, u, I = !1;
                d.length && (m || h) && r && void 0 !== r.min && (q = r.reversed, D = r.horiz, m && m.hide(), h && h.hide(),
                    ...
                    r.isXAxis ? (g = {
                        ...
                        width: C,
                        height: l
                    }, D || (g.x = b.plotHeight - g.x)) : (g = {
                        x: 0,
                        y: z ? u : t,
                        width: l,
                        height: C
                    }, D && (g.y = b.plotWidth - g.y));
                    z && c.isVML && (g = r.isXAxis ? {x: 0, y: q ? t : u, height: g.width, width: b.chartWidth} : {
            ...
            render: function () {
                var a = this, b = a.chart, c, d = a.options,
                    ...
                    f = a.visible ? "inherit" : "hidden", g = d.zIndex, m = a.hasRendered, h = b.seriesGroup,
                    l = b.inverted;
            ...
            redraw: function () {
                ...
                c && (a.inverted && c.attr({width: a.plotWidth, height: a.plotHeight}), c.animate({
                    translateX: w(d && d.left, a.plotLeft), translateY: w(e && e.top,
                        a.plotTop)
                }));
                this.translate();
                this.render();
            ...
            buildKDTree: function () {
                function a(c, d, e) {
                    var f, k;
                    if (k = c && c.length) return f = b.kdAxisArray[d % e], c.sort(function (a, b) {
                        return a[f] - b[f]
                    }), k = Math.floor(k / 2), {
                        point: c[k], left: a(c.slice(0, k), d + 1, e), right: a(c.slice(k +
                            1), d + 1, e)
                    }
                }
    ...
    (function (a) {
        var A = a.Axis, H = a.Chart, F = a.correctFloat, q = a.defined, h = a.destroyObjectProperties, l = a.each, t =
            a.format, n = a.objectEach, v = a.pick, u = a.Series;
        a.StackItem = function (a, d, g, e, c) {
            ...
            this.alignOptions = {
                align: d.align || (b ? g ? "left" : "right" : "center"),
                verticalAlign: d.verticalAlign || (b ? "middle" : g ? "bottom" : "top"),
                y: v(d.y, b ? 4 : g ? 14 : -6),
                x: v(d.x, b ? g ? -6 : 6 : 0)
            };
            this.textAlign = d.textAlign || (b ? g ? "right" : "left" : "center")
        };
        a.StackItem.prototype = {
            destroy: function () {
                ...
                var b = this.axis.chart, g = this.options, e = g.format,
                    e = e ? t(e, this, b.time) : g.formatter.call(this);
                this.label ? this.label.attr({
                    text: e,
                    visibility: "hidden"
                }) : this.label = b.renderer.text(e, null, null, g.useHTML).css(g.style).attr({
                    align: this.textAlign,
                    rotation: g.rotation,
                    visibility: "hidden"
                }).add(a)
            }, setOffset: function (a, d) {
                var b = this.axis, e = b.chart, c = b.translate(b.usePercentage ? 100 : this.total, 0, 0, 0, 1),
                    b = b.translate(0), b = Math.abs(c - b);
            ...
            }, getStackBox: function (a, d, g, e, c, m) {
                var b = d.axis.reversed, h = a.inverted;
                a = a.plotHeight;
                d = d.isNegative && !b || !d.isNegative && b;
                return {
                    x: h ? d ? e : e - m : g,
                    y: h ? a - g - c : d ? a - e - m : a - e,
                    width: h ? m : c,
                    height: h ? c : m
                }
            }
        ...
        A.prototype.buildStacks = function () {
            var a = this.series, d = v(this.options.reversedStacks, !0), g = a.length, e;
            if (!this.isXAxis) {
                this.usePercentage = !1;
                for (e = g; e--;) a[d ? e : g - e - 1].setStackedPoints();
                for (e = 0; e < g; e++) a[e].modifyStacks()
            }
        };
        ...
        u.prototype.setStackedPoints = function () {
            if (this.options.stacking &&
                ...
                var b = this.processedXData, d = this.processedYData, g = [], e = d.length, c = this.options,
                    m = c.threshold, f = v(c.startFromThreshold && m, 0), h = c.stack, c = c.stacking,
                    l = this.stackKey, n = "-" + l, z = this.negStacks, t = this.yAxis, D = t.stacks, C = t.oldStacks,
                    y, u, B, J, E, k, p;
                t.stacksTouched += 1;
                for (E = 0; E < e; E++) k = b[E], p = d[E], y = this.getStackIndicator(y, k, this.index), J = y.key, B = (u = z && p < (f ? 0 : m)) ? n : l, D[B] || (D[B] = {}), D[B][k] || (C[B] && C[B][k] ? (D[B][k] = C[B][k], D[B][k].total =
                    ...
                    f) + (p || 0), null !== p && (B.points[J].push(B.cumulative), g[E] = B.cumulative);
        ...
        u.prototype.modifyStacks = function () {
            var a = this, d = a.stackKey, g = a.yAxis.stacks, e = a.processedXData, c, m = a.options.stacking;
            a[m + "Stacker"] && l([d, "-" + d], function (b) {
                for (var d = e.length, f, h; d--;) if (f = e[d], c = a.getStackIndicator(c, f, a.index, b), h = (f = g[b] && g[b][f]) && f.points[c.key]) a[m + "Stacker"](h, f, d)
            })
        };
        ...
        u.prototype.getStackIndicator = function (a, d, g, e) {
            !q(a) || a.x !== d || e && a.key !== e ? a = {x: d, index: 0, key: e} : a.index++;
            a.key = [g, d, a.index].join();
            return a
        }
    })(L);
    (function (a) {
        var A = a.addEvent, H = a.animate, F = a.Axis, q = a.createElement, h = a.css, l = a.defined, t = a.each,
            n = a.erase, v = a.extend, u = a.fireEvent, b = a.inArray, d = a.isNumber, g = a.isObject, e = a.isArray,
            c = a.merge, m = a.objectEach, f = a.pick, r = a.Point, w = a.Series, K = a.seriesTypes, z = a.setAnimation,
            I = a.splat;
        v(a.Chart.prototype,
            {
                addSeries: function (a, b, c) {
                    var d, e = this;
                    a && (b = f(b, !0), u(e, "addSeries", {options: a}, function () {
                        d = e.initSeries(a);
                        e.isDirtyLegend = !0;
                        e.linkSeries();
                        b && e.redraw(c)
                ...
                addAxis: function (a, b, d, e) {
                    ...
                    a = c(a, {index: this[g].length, isX: b});
                    b = new F(this, a);
                    m[g] = I(m[g] || {});
                    m[g].push(a);
                    f(d, !0) && this.redraw(e);
                ...
                showLoading: function (a) {
                    ...
                    b.loadingShown || (h(d, {
                        opacity: 0,
                        display: ""
                    }), H(d, {opacity: e.style.opacity || .5}, {duration: e.showDuration || 0}));
                    b.loadingShown = !0;
                    f()
                },
                ...
                update: function (a, e, g) {
                    var h = this, r = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, n = a.chart,
                        q, k, p = [];
                    if (n) {
                        c(!0, h.options.chart, n);
                        "className" in n && h.setClassName(n.className);
                        if ("inverted" in n || "polar" in n) h.propFromSeries(), q = !0;
                        "alignTicks" in n && (q = !0);
                        m(n, function (a, c) {
                    ...
                    m(a, function (a, c) {
                        if (h[c] && "function" === typeof h[c].update) h[c].update(a, !1); else if ("function" === typeof h[r[c]]) h[r[c]](a);
                        "chart" !== c && -1 !== b(c, h.propsRequireUpdateSeries) && (k = !0)
                    });
                    t("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
                        a[b] && (t(I(a[b]), function (a, c) {
                            (c = l(a.id) && h.get(a.id) || h[b][c]) && c.coll === b && (c.update(a,
                                !1), g && (c.touched = !0));
                            if (!c && g) if ("series" === b) h.addSeries(a, !1).touched = !0; else if ("xAxis" === b || "yAxis" === b) h.addAxis(a, "xAxis" === b, !1).touched = !0
                        }), g && t(h[b], function (a) {
        ...
        v(w.prototype, {
            addPoint: function (a, b, c, d) {
                var e = this.options, g = this.data, h = this.chart, k = this.xAxis, k = k && k.hasNames && k.names,
                    m = e.data, l, r, n = this.xData, q, z;
                b = f(b, !0);
                l = {series: this};
                ...
                var d = this, e = d.chart, g = d.userOptions, h = d.oldType || d.type,
                    m = a.type || g.type || e.options.chart.type,
                    k = K[h].prototype, l, r = ["group", "markerGroup", "dataLabelsGroup"],
                    n = ["navigatorSeries", "baseSeries"], q = d.finishedAnimating && {animation: !1};
                ...
                d.remove(!1, null, !1);
                for (l in k) d[l] = void 0;
                v(d, K[m || h].prototype);
                t(n, function (a) {
                    d[a] = n[a]
                });
                d.init(e, a);
                a.zIndex !== g.zIndex && t(r, function (b) {
    ...
    (function (a) {
        ...
        l("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function (h) {
                var l = [], t = [], u = this.xAxis, b = this.yAxis, d = b.stacks[this.stackKey], g = {}, e = this.index,
                    c = b.series, m = c.length, f, r = q(b.options.reversedStacks, !0) ? 1 : -1, w;
                h = h || this.points;
                if (this.options.stacking) {
                    for (w = 0; w < h.length; w++) h[w].leftNull = h[w].rightNull = null, g[h[w].x] = h[w];
                    ...
                    H(t, function (a, c) {
                        var h = 0, n, q;
                        if (g[a] && !g[a].isNull) l.push(g[a]), H([-1, 1], function (b) {
                            var h = 1 === b ? "rightNull" : "leftNull", l = 0, z = d[t[c + b]];
                            if (z) for (w = e; 0 <= w && w < m;) n = z.points[w], n || (w === e ? g[a][h] = !0 : f[w] && (q = d[a].points[w]) && (l -= q[1] - q[0])), w += r;
                ...
                var l = h.prototype.getGraphPath, t = this.options, u = t.stacking, b = this.yAxis, d, g, e = [],
                    c = [], m = this.index, f, r = b.stacks[this.stackKey], w = t.threshold,
                    A = b.getThreshold(t.threshold), z, t = t.connectNulls || "percent" === u, I = function (d, g, h) {
                        var l = a[d];
                        d = u && r[l.x].points[m];
                        var n = l[h + "Null"] || 0;
                        h = l[h + "Cliff"] || 0;
                        ...
                        void 0 !== q && (c.push({
                            plotX: f,
                            plotY: null === q ? A : b.getThreshold(q),
                            isNull: l,
                            isCliff: !0
                        }), e.push({plotX: f, plotY: null === z ? A : b.getThreshold(z), doCurve: !1}))
                    };
                a = a || this.points;
                u && (a = this.getStackPoints(a));
                for (d = 0; d < a.length; d++) if (g = a[d].isNull, f = q(a[d].rectPlotX, a[d].plotX), z = q(a[d].yBottom, A), !g || t) t || I(d, d - 1, "left"), g && !u && t || (c.push(a[d]), e.push({
                    x: d,
                    plotX: f,
                    plotY: z
                })), t || I(d, d + 1, "right");
                ...
                H(u, function (b) {
                    ...
                    g ? (g.endX = a.preventGraphAnimation ?
                        null : l.xMap, g.animate({d: l})) : (g = a[d] = a.chart.renderer.path(l).addClass(b[1]).attr({
                        fill: q(b[3], A(b[2]).setOpacity(q(v.fillOpacity, .75)).get()),
                        zIndex: 0
    ...
    (function (a) {
        var A = a.animObject, H = a.color, F = a.each, q = a.extend, h = a.isNumber, l = a.merge, t = a.pick,
        ...
        v("column", "line", {
            ...
            init: function () {
                ...
                d.hasRendered && F(d.series, function (b) {
                    b.type === a.type && (b.isDirty = !0)
                })
            },
            getColumnMetrics: function () {
                var a = this, d = a.options, g = a.xAxis,
                    e = a.yAxis, c = g.reversed, h, f = {}, l = 0;
                !1 === d.grouping ? l = 1 : F(a.chart.series, function (b) {
                    var c = b.options, d = b.yAxis, g;
                    b.type !== a.type || !b.visible && a.chart.options.chart.ignoreHiddenSeries || e.len !== d.len || e.pos !== d.pos || (c.stacking ? (h = b.stackKey, void 0 === f[h] && (f[h] = l++), g = f[h]) : !1 !== c.grouping && (g = l++), b.columnIndex = g)
                });
                var n = Math.min(Math.abs(g.transA) * (g.ordinalSlope || d.pointRange || g.closestPointRange || g.tickInterval || 1), g.len),
                    q = n * d.groupPadding, z = (n - 2 * q) / (l || 1),
                    d = Math.min(d.maxPointWidth || g.len, t(d.pointWidth,
                        z * (1 - 2 * d.pointPadding)));
                a.columnMetrics = {
                    width: d,
                    offset: (z - d) / 2 + (q + ((a.columnIndex || 0) + (c ? 1 : 0)) * z - n / 2) * (c ? -1 : 1)
                };
                return a.columnMetrics
            },
            crispCol: function (a, d, g, e) {
                var b = this.chart, h = this.borderWidth, f = -(h % 2 ? .5 : 0), h = h % 2 ? .5 : 1;
                b.inverted && b.renderer.isVML && (h += 1);
                this.options.crisp && (g = Math.round(a + g) + f, a = Math.round(a) + f, g -= a);
                e = Math.round(d + e) + h;
                f = .5 >= Math.abs(d) && .5 < e;
                d = Math.round(d) + h;
                e -= d;
                f && e && (--d, e += 1);
                return {x: a, y: d, width: g, height: e}
            },
            translate: function () {
                var a = this, d = a.chart, h = a.options, e =
                        a.dense = 2 > a.closestPointRange * a.xAxis.transA, e = a.borderWidth = t(h.borderWidth, e ? 0 : 1),
                    c = a.yAxis, m = h.threshold, f = a.translatedThreshold = c.getThreshold(m),
                    l = t(h.minPointLength, 5), q = a.getColumnMetrics(), u = q.width,
                    z = a.barW = Math.max(u, 1 + 2 * e), v = a.pointXOffset = q.offset;
                d.inverted && (f -= .5);
                h.pointPadding && (z = Math.ceil(z));
                n.prototype.translate.apply(a);
                F(a.points, function (b) {
                    var e = t(b.yBottom, f), h = 999 + Math.abs(e), h = Math.min(Math.max(-h, b.plotY), c.len + h),
                        g = b.plotX + v, r = z, n = Math.min(h, e), q, k = Math.max(h, e) - n;
                    l &&
            ...
            pointAttribs: function (a, d) {
                ...
                var h = c["stroke-width"] || "borderWidth", f = a && a.color || this.color,
                    r = a && a[e] || b[e] || this.color || f, n = a && a[h] || b[h] || this[h] || 0, c = b.dashStyle;
            ...
            drawPoints: function () {
                ...
                F(a.points, function (b) {
                    ...
                    if (h(b.plotY) && null !== b.y) {
                        m = b.shapeArgs;
                        if (f) f[d.pointCount < c ? "animate" : "attr"](l(m)); else b.graphic = f = e[b.shapeType](m).add(b.group || a.group);
            ...
            animate: function (a) {
                var b = this, h = this.yAxis, e = b.options, c = this.chart.inverted, m = {},
                    f = c ? "translateX" : "translateY", l;
                u && (a ? (m.scaleY = .001, a = Math.min(h.pos + h.len, Math.max(h.pos, h.toPixels(e.threshold))), c ? m.translateX = a - h.len : m.translateY = a, b.group.attr(m)) : (l = b.group.attr(f), b.group.animate({scaleY: 1}, q(A(b.options.animation), {
                    step: function (a, c) {
                        m[f] = l + c.pos * (h.pos - l);
                        b.group.attr(m)
                    }
        ...
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, l = this.chart, t = 2 * (a.slicedOffset || 0), n = l.plotWidth - 2 * t,
                    ...
                    v = [F(v[0], "50%"), F(v[1], "50%"), a.size || "100%", a.innerSize || 0], u = Math.min(n,
                    l), b, d;
                for (b = 0; 4 > b; ++b) d = v[b], a = 2 > b || 2 === b && /%$/.test(d), v[b] = q(d, [n, l, u, v[2]][b]) + (a ? t : 0);
                v[3] > v[2] && (v[3] = v[2]);
                return v
            }, getStartAndEndRadians: function (a, l) {
                a = H(a) ? a : 0;
                l = H(l) && l > a && 360 > l - a ? l : a + 360;
                return {start: A * (a + -90), end: A * (l + -90)}
            }
        }
    })(L);
    (function (a) {
        var A = a.addEvent, H = a.CenteredSeriesMixin, F = a.defined, q = a.each, h = a.extend,
            l = H.getStartAndEndRadians, t = a.inArray, n = a.noop, v = a.pick, u = a.Point, b = a.Series,
            d = a.seriesType, g = a.setAnimation;
        d("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            updateTotals: function () {
                var a, b = 0, d = this.points, f = d.length, h, g = this.options.ignoreHiddenPoint;
                for (a = 0; a < f; a++) h = d[a], b += g && !h.visible ? 0 : h.isNull ? 0 : h.y;
                this.total = b;
                for (a = 0; a < f; a++) h = d[a], h.percentage = 0 < b && (h.visible || !g) ? h.y / b * 100 : 0, h.total = b
            },
            generatePoints: function () {
            ...
            translate: function (a) {
                this.generatePoints();
                var b = 0, d = this.options, e = d.slicedOffset, h = e + (d.borderWidth || 0), g, n, q,
                    t = l(d.startAngle, d.endAngle), u = this.startAngleRad = t.start,
                    t = (this.endAngleRad = t.end) - u, C = this.points, y, G = d.dataLabels.distance,
                    d = d.ignoreHiddenPoint, B, A = C.length, E;
                ...
                for (B = 0; B < A; B++) {
                    ...
                    g = u + b * t;
                    if (!d || E.visible) b += E.percentage / 100;
                    n = u + b * t;
                    E.shapeType = "arc";
                    E.shapeArgs = {
                        x: a[0],
            ...
            drawPoints: function () {
                ...
                q(a.points, function (c) {
                    f =
                        c.graphic;
                    if (c.isNull) f && (c.graphic = f.destroy()); else {
                        l = c.shapeArgs;
                        d = c.getTranslate();
                        var e = c.shadowGroup;
            ...
            init: function () {
                ...
                b = v(b, h);
                a !== c.visible && (c.visible = c.options.visible = a = void 0 === a ? !c.visible : a, d.options.data[t(c, d.data)] = c.options, q(["graphic", "dataLabel", "connector", "shadowGroup"], function (b) {
                    if (c[b]) c[b][a ? "show" : "hide"](!0)
                }), c.legendItem && e.legend.colorizeItem(c, a), a || "hover" !== c.state || c.setState(""), h && (d.isDirty = !0), b && e.redraw())
    ...
    (function (a) {
        var A = a.addEvent, H = a.arrayMax, F = a.defined, q = a.each, h = a.extend, l = a.format, t = a.map,
            n = a.merge, v = a.noop, u = a.pick, b = a.relativeLength, d =
                a.Series, g = a.seriesTypes, e = a.stableSort;
        a.distribute = function (a, b) {
            ...
            for (a = t(a, function (a) {
                ...
                for (d = a.length; d--;) h = a[d], m = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2, h.pos = Math.min(Math.max(0, m - h.size *
                    h.align), b - h.size);
                d = a.length;
                for (h = !1; d--;) 0 < d && a[d - 1].pos + a[d - 1].size > a[d].pos && (a[d - 1].size += a[d].size, a[d - 1].targets = a[d - 1].targets.concat(a[d].targets), a[d - 1].align = .5, a[d - 1].pos + a[d - 1].size > b && (a[d - 1].pos = b - a[d - 1].size), a.splice(d, 1), h = !0)
            }
            d = 0;
            q(a, function (a) {
                var b = 0;
        ...
        d.prototype.drawDataLabels = function () {
            ...
            var d = this, e = d.chart, h = d.options, g = h.dataLabels, t = d.points, z, v, D = d.hasRendered || 0, C,
                y, G = u(g.defer, !!h.animation), B = e.renderer;
            if (g.enabled || d._hasPointLabels) d.dlProcessOptions && d.dlProcessOptions(g), y = d.plotGroup("dataLabelsGroup", "data-labels", G && !D ? "hidden" : "visible", g.zIndex || 6), G && (y.attr({opacity: +D}), D || A(d, "afterAnimate", function () {
                d.visible && y.show(!0);
                y[h.animation ? "animate" : "attr"]({opacity: 1},
                    {duration: 200})
            })), v = g, q(t, function (c) {
                ...
                f && (g = n(v, z), m = c.getLabelConfig(), w = g[c.formatPrefix + "Format"] || g.format, C = F(w) ? l(w, m, e.time) : (g[c.formatPrefix + "Formatter"] || g.formatter).call(m, g), w = g.style, m = g.rotation, w.color = u(g.color, w.color, d.color, "#000000"), "contrast" === w.color && (c.contrastColor = B.getContrast(c.color || d.color), w.color = g.inside || 0 > u(c.labelDistance,
                    g.distance) || h.stacking ? c.contrastColor : "#000000"), h.cursor && (w.cursor = h.cursor), q = {
        ...
        d.prototype.alignDataLabel = function (a, b, d, e, g) {
            var c = this.chart, f = c.inverted, l = u(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
                m = u(a.plotY, -9999), n = b.getBBox(), q, r = d.rotation, t = d.align,
                w = this.visible && (a.series.forceDL || c.isInsidePlot(l, Math.round(m), f) || e && c.isInsidePlot(l, f ? e.x + 1 : e.y + e.height - 1, f)),
                v = "justify" === u(d.overflow,
                    "justify");
            if (w && (q = d.style.fontSize, q = c.renderer.fontMetrics(q, b).b, e = h({
                    ...
                    width: n.width,
                    height: n.height
                }), r ? (v = !1, l = c.renderer.rotCorr(q, r), l = {
                        x: e.x + d.x + e.width / 2 + l.x,
                        y: e.y + d.y + {top: 0, middle: .5, bottom: 1}[d.verticalAlign] * e.height
                    }, b[g ? "attr" : "animate"](l).attr({align: t}), m = (r + 720) % 360, m = 180 < m && 360 > m, "left" === t ? l.y -= m ? n.height : 0 : "center" === t ? (l.x -= n.width / 2, l.y -= n.height / 2) : "right" === t && (l.x -= n.width, l.y -= m ? 0 : n.height)) :
                    (b.align(d, null, e), l = b.alignAttr), v ? a.isLabelJustified = this.justifyDataLabel(b, d, l, n, e, g) : u(d.crop, !0) && (w = c.isInsidePlot(l.x, l.y) && c.isInsidePlot(l.x + n.width, l.y + n.height)), d.shape && !r)) b[g ? "attr" : "animate"]({
        ...
        g.pie && (g.pie.prototype.drawDataLabels = function () {
            var b = this, e = b.data, f, h = b.chart, g = b.options.dataLabels, l = u(g.connectorPadding, 10),
                n = u(g.connectorWidth, 1), t = h.plotWidth, v = h.plotHeight, C, y = b.center, G = y[2] / 2, B = y[1],
                A, E,
                k, p, M = [[], []], O, N, P, L, x = [0, 0, 0, 0];
            b.visible && (g.enabled || b._hasPointLabels) && (q(e, function (a) {
                a.dataLabel && a.visible && a.dataLabel.shortened && (a.dataLabel.attr({width: "auto"}).css({
                    width: "auto",
                    textOverflow: "clip"
                }), a.dataLabel.shortened = !1)
            }), d.prototype.drawDataLabels.apply(b), q(e, function (a) {
                a.dataLabel && a.visible && (M[a.half].push(a), a.dataLabel._pos = null)
            }), q(M, function (c, d) {
                var e, m, n = c.length, r = [], z;
                if (n) for (b.sortByAngle(c, d - .5), 0 < b.maxLabelDistance && (e = Math.max(0, B - G - b.maxLabelDistance), m = Math.min(B +
                    G + b.maxLabelDistance, h.plotHeight), q(c, function (a) {
                    0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, B - G - a.labelDistance), a.bottom = Math.min(B + G + a.labelDistance, h.plotHeight), z = a.dataLabel.getBBox().height || 21, a.positionsIndex = r.push({
                        target: a.labelPos[1] - a.top + z / 2,
                        size: z,
                        rank: a.y
                    }) - 1)
                }), a.distribute(r, m + z - e)), L = 0; L < n; L++) f = c[L], m = f.positionsIndex, k = f.labelPos, A = f.dataLabel, P = !1 === f.visible ? "hidden" : "inherit", N = e = k[1], r && F(r[m]) && (void 0 === r[m].pos ? P = "hidden" : (p = r[m].size, N = f.top + r[m].pos)), delete f.positionIndex,
                    O = g.justify ? y[0] + (d ? -1 : 1) * (G + f.labelDistance) : b.getX(N < f.top + 2 || N > f.bottom - 2 ? e : N, d, f), A._attr = {
                    visibility: P,
                    align: k[6]
                }, A._pos = {
                    x: O + g.x + ({left: l, right: -l}[k[6]] || 0),
                    y: N + g.y - 10
                }, k.x = O, k.y = N, u(g.crop, !0) && (E = A.getBBox().width, e = null, O - E < l ? (e = Math.round(E - O + l), x[3] = Math.max(e, x[3])) : O + E > t - l && (e = Math.round(O + E - t + l), x[1] = Math.max(e, x[1])), 0 > N - p / 2 ? x[0] = Math.max(Math.round(-N + p / 2), x[0]) : N + p / 2 > v && (x[2] = Math.max(Math.round(N + p / 2 - v), x[2])), A.sideOverflow = e)
            }), 0 === H(x) || this.verifyDataLabelOverflow(x)) && (this.placeDataLabels(),
            n && q(this.points, function (a) {
                var c;
                C = a.connector;
                if ((A = a.dataLabel) && A._pos && a.visible && 0 < a.labelDistance) {
                    P = A._attr.visibility;
                    if (c = !C) a.connector = C = h.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(b.dataLabelsGroup), C.attr({
                        "stroke-width": n,
        ...
        g.column && (g.column.prototype.alignDataLabel = function (a, b, e, g, h) {
            var c = this.chart.inverted, f = a.series, l = a.dlBox || a.shapeArgs,
                m = u(a.below, a.plotY > u(this.translatedThreshold, f.yAxis.len)),
                q = u(e.inside, !!this.options.stacking);
            l && (g = n(l), 0 > g.y && (g.height += g.y, g.y = 0), l = g.y + g.height - f.yAxis.len, 0 < l && (g.height -= l), c && (g = {
                x: f.yAxis.len - g.y - g.height,
                y: f.xAxis.len - g.x - g.width,
                width: g.height,
                height: g.width
            }), q || (c ? (g.x += m ? 0 : g.width, g.width = 0) : (g.y +=
    ...
    (function (a) {
        ...
        a(A.prototype, "render", function () {
            var a = [];
            H(this.labelCollectors || [], function (h) {
                a = a.concat(h())
            });
            H(this.yAxis || [], function (h) {
                h.options.stackLabels &&
                !h.options.stackLabels.allowOverlap && F(h.stacks, function (h) {
                    F(h, function (h) {
                        a.push(h.label)
                    })
                })
            });
            H(this.series || [], function (h) {
                var l = h.options.dataLabels, n = h.dataLabelCollections || ["dataLabel"];
                (l.enabled || h._hasPointLabels) && !l.allowOverlap && h.visible && H(n, function (l) {
                    H(h.points, function (h) {
                        h[l] && (h[l].labelrank = q(h.labelrank, h.shapeArgs && h.shapeArgs.height), a.push(h[l]))
                    })
                })
            });
        ...
        A.prototype.hideOverlappingLabels = function (a) {
            var h = a.length, q, n, v, u, b, d, g, e, c, m = function (a,
                                                                       b, c, d, e, g, h, l) {
                return !(e > a + c || e + h < a || g > b + d || g + l < b)
            };
            for (n = 0; n < h; n++) if (q = a[n]) q.oldOpacity = q.opacity, q.newOpacity = 1, q.width || (v = q.getBBox(), q.width = v.width, q.height = v.height);
            a.sort(function (a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (n = 0; n < h; n++) for (v = a[n], q = n + 1; q < h; ++q) if (u = a[q], v && u && v !== u && v.placed && u.placed && 0 !== v.newOpacity && 0 !== u.newOpacity && (b = v.alignAttr, d = u.alignAttr, g = v.parentGroup, e = u.parentGroup, c = 2 * (v.box ? 0 : v.padding || 0), b = m(b.x + g.translateX, b.y + g.translateY, v.width - c, v.height -
    ...
    (function (a) {
        var A = a.addEvent, H = a.Chart, F = a.createElement, q = a.css, h = a.defaultOptions, l = a.defaultPlotOptions,
            t = a.each, n = a.extend, v = a.fireEvent, u = a.hasTouch, b = a.inArray, d = a.isObject, g = a.Legend,
            e = a.merge,
            c = a.pick, m = a.Point, f = a.Series, r = a.seriesTypes, w = a.svg, K;
        K = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                    e = d.length, f = a.chart, g = f.pointer, h = f.renderer, l = f.options.tooltip.snap, k = a.tracker,
                    m, n = function () {
                        if (f.hoverSeries !== a) a.onMouseOver()
                    }, q = "rgba(192,192,192," + (w ? .0001 : .002) + ")";
        ...
        n(g.prototype, {
            setItemEvents: function (a, b, c) {
                var d = this, f = d.chart.renderer.boxWrapper,
        ...
        n(H.prototype, {
            showResetZoom: function () {
                var a = this, b = h.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states,
                ...
                t("xy" === b ? [1, 0] : [1], function (b) {
                    ...
                    var d = b.horiz, f = a[d ? "chartX" : "chartY"], d = d ? "mouseDownX" : "mouseDownY", g = c[d],
                        k = (b.pointRange || 0) / 2, h = b.getExtremes(), l = b.toValue(g - f, !0) + k,
                        m = b.toValue(g + b.len - f, !0) - k, n = m < l, g = n ? m : l, l = n ? l : m,
                        m = Math.min(h.dataMin, k ? h.min : b.toValue(b.toPixels(h.min) - b.minPixelPadding)),
                        k = Math.max(h.dataMax, k ? h.max : b.toValue(b.toPixels(h.max) + b.minPixelPadding)),
                        n = m - g;
                    0 < n && (l += n, g = m);
                    n = l - k;
                    0 < n && (l = k, g -= n);
        ...
        n(m.prototype, {
            select: function (a, d) {
                ...
                a = c(a, !e.selected);
                e.firePointEvent(a ? "select" : "unselect", {accumulate: d}, function () {
                ...
                var d = Math.floor(this.plotX),
                    e = this.plotY, f = this.series, g = f.options.states[a || "normal"] || {},
                    h = l[f.type].marker && f.options.marker, m = h && !1 === h.enabled,
                    q = h && h.states && h.states[a || "normal"] || {}, k = !1 === q.enabled, p = f.stateMarkerGraphic,
                    r = this.marker || {}, t = f.chart, u = f.halo, v, w = h && f.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (k || m && !1 === q.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" +
                        this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(f.pointAttribs(this, a), c(t.options.chart.animation, g.animation)), v && this.graphic.animate(v, c(t.options.chart.animation, q.animation, h.animation)), p && p.hide(); else {
                        if (a && q) {
                            h = r.symbol || f.symbol;
                            ...
                            if (p) p[b ? "animate" : "attr"]({
                                x: v.x,
                                y: v.y
                            }); else h && (f.stateMarkerGraphic = p = t.renderer.symbol(h, v.x, v.y, v.width, v.height).add(f.markerGroup), p.currentSymbol = h);
                            p && p.attr(f.pointAttribs(this,
                                a))
                        }
                        p && (p[a && t.isInsidePlot(d, e, t.inverted) ? "show" : "hide"](), p.element.point = this)
                    }
                    (d = g.halo) && d.size ? (u || (f.halo = u = t.renderer.path().add((this.graphic || p).parentGroup)), u.show()[b ? "animate" : "attr"]({d: this.haloPath(d.size)}), u.attr({"class": "highcharts-halo highcharts-color-" + c(this.colorIndex, f.colorIndex)}), u.point = this, u.attr(n({
                        fill: this.color || f.color,
                        "fill-opacity": d.opacity,
                        zIndex: -1
                    }, d.attributes))) : u && u.point && u.point.haloPath && u.animate({d: u.point.haloPath(0)}, null, u.hide);
                    this.state = a
                }
            },
            haloPath: function (a) {
        ...
        n(f.prototype, {
            onMouseOver: function () {
                ...
                if (b.state !== a && (t([b.group, b.markerGroup, b.dataLabelsGroup], function (c) {
                    ...
                    }), b.state = a, !f[a] || !1 !== f[a].enabled) && (a && (g = f[a].lineWidth || g + (f[a].lineWidthPlus || 0)), e && !e.dashstyle)) for (g = {"stroke-width": g}, e.animate(g, c(f[a || "normal"] && f[a || "normal"].animation,
    ...
    (function (a) {
        ...
        A.prototype.setResponsive = function (h) {
            ...
            l && l.rules && H(l.rules, function (b) {
                ...
                this.matchResponsiveRule(b, n, h)
            }, this);
            ...
            n !== (b && b.ruleIds) && (b && this.update(b.undoOptions, h), n ? (this.currentResponsive = {
                    ruleIds: n,
                    mergedOptions: d,
        ...
        A.prototype.currentOptions = function (l) {
            function n(b, d, g, e) {
                var c;
                a.objectEach(b, function (a, b) {
                    if (!e && -1 < F(b, ["series", "xAxis", "yAxis"])) for (a = t(a), g[b] = [], c = 0; c < a.length; c++) d[b][c] &&
                    (g[b][c] = {}, n(a[c], d[b][c], g[b][c], e + 1)); else h(a) ? (g[b] = q(a) ? [] : {}, n(a, d[b] || {}, g[b], e + 1)) : g[b] = d[b] || null
                })
            }
